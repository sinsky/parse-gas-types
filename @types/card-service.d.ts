...
[Developer Preview](https://developers.google.com/workspace/preview).
@return An empty validation.*/ newValidation(): CardService.Validation;
}
module CardService {
  interface WrapStyle {}
  interface _WrapStyle {
    /**No wrapping. Default.*/ NOWRAP: WrapStyle;
    /**Wraps the content for any widgets in a column.*/ WRAP: WrapStyle;
  }
  interface Widget {}
  ...
  interface _VerticalAlignment {
    ...
    /**Vertically places the content at the top of the container.*/ TOP: VerticalAlignment;
  }
...
@return This object, for chaining.*/ setCharacterLimit(
      characterLimit: Integer,
    ): CardService.Validation;
...
@return This object, for chaining.*/ setInputType(
      inputType: CardService.InputType,
    ): CardService.Validation;
  }
...
@param bottomText For multiselect menus, a text description or label that's displayed below the
    item's text field.
@return This object, for chaining.*/ addItem(
      text: Object,
      value: Object,
      selected: boolean,
      startIconUri: Object,
      bottomText: Object,
    ): CardService.UpdatedWidget;
  }
...
@return This object, for chaining.*/ addUpdateToRecipients(
...
@return This object, for chaining.*/ addUpdateSubject(
      subject: string,
...
@return This object, for chaining.*/ addUpdateCcRecipients(
      ccRecipientEmails: string[],
    ): CardService.UpdateDraftCcRecipientsAction;
  }
  interface UpdateDraftBodyType {}
  interface _UpdateDraftBodyType {
...
content.*/ IN_PLACE_INSERT: UpdateDraftBodyType;
  }
...
@return This object, for chaining.*/ addUpdateContent(
      content: string,
...
@return This object, for chaining.*/ setUpdateType(
...
@return This object, for chaining.*/ addUpdateBccRecipients(
...
@return This object, for chaining.*/ setUpdateDraftBccRecipientsAction(
...
@return This object, for chaining.*/ setUpdateDraftBodyAction(
...
@return This object, for chaining.*/ setUpdateDraftCcRecipientsAction(
...
@return This object, for chaining.*/ setUpdateDraftSubjectAction(
...
@return This object, for chaining.*/ setUpdateDraftToRecipientsAction(
...
@return This object, for chaining.*/ displayAddOnCards(
      cardObjects: Object[],
...
@return This object, for chaining.*/ setOpenLink(
...
@return This picker, for chaining.*/ setFieldName(
      fieldName: string,
...
@return This picker, for chaining.*/ setHours(
      hours: Integer,
    ): CardService.TimePicker;
...
@param minutes The default minutes value placed in the input, range from 0 to 59. It is always
    represented as a string in the form callback parameters.
@return This picker, for chaining.*/ setMinutes(
      minutes: Integer,
    ): CardService.TimePicker;
...
@return This picker, for chaining.*/ setOnChangeAction(
      action: CardService.Action,
    ): CardService.TimePicker;
    /**Sets the title displayed above the input field.
@param title The input field title.
@return This picker, for chaining.*/ setTitle(
      title: string,
    ): CardService.TimePicker;
  }
...
@return This object, for chaining.*/ setMaxLines(
      maxLines: Integer,
    ): CardService.TextParagraph;
    /**Sets the text of the paragraph. Required.
@param text The text to display.
@return This object, for chaining.*/ setText(
      text: string,
    ): CardService.TextParagraph;
  }
  interface TextInput {
...
@return This object, for chaining.*/ setFieldName(
      fieldName: string,
...
@return This object, for chaining.*/ setSuggestionsAction(
...
@return This object, for chaining.*/ setTitle(
      title: string,
    ): CardService.TextInput;
...
@return This object, for chaining.*/ setValidation(
      validation: CardService.Validation,
    ): CardService.TextInput;
...
being used by any apps.*/ TEXT: TextButtonStyle;
  }
...
@return This object, for chaining.*/ setAltText(
      altText: string,
...
@param action The object that specifies the authorization action to take when this element is
    clicked.
@return This object, for chaining.*/ setAuthorizationAction(
...
@return This object, for chaining.*/ setBackgroundColor(
...
@return This object, for chaining.*/ setComposeAction(
      action: CardService.Action,
...
@return This object, for chaining.*/ setDisabled(
      disabled: boolean,
    ): CardService.TextButton;
...
@return This object, for chaining.*/ setIcon(
...
@return This object, for chaining.*/ setIconUrl(
      url: string,
    ): CardService.TextButton;
...
@return This object, for chaining.*/ setMaterialIcon(
      icon: CardService.MaterialIcon,
    ): CardService.TextButton;
...
@return This object, for chaining.*/ setOnClickAction(
      action: CardService.Action,
    ): CardService.TextButton;
...
@param action The object that specifies the open link action to take when this element is
    clicked.
@return This object, for chaining.*/ setOnClickOpenLinkAction(
      action: CardService.Action,
    ): CardService.TextButton;
...
@param menu The object that specifies the overflow menu to display when this element is
    clicked.
@return This object, for chaining.*/ setOverflowMenu(
      menu: CardService.OverflowMenu,
    ): CardService.TextButton;
...
@return This object, for chaining.*/ setTextButtonStyle(
      textButtonStyle: CardService.TextButtonStyle,
    ): CardService.TextButton;
  }
  interface SwitchControlType {}
  interface _SwitchControlType {
    /**Checkbox-styled control for a switch widget.*/ CHECK_BOX: SwitchControlType;
    /**Toggle-styled control for a switch widget. Default.*/ SWITCH: SwitchControlType;
  }
  interface Switch {
    /**Sets the control type of the switch. Defaults to `SWITCH`.
@param controlType The switch control type.
@return This object, for chaining.*/ setControlType(
...
@return This object, for chaining.*/ setSelected(
      selected: boolean,
    ): CardService.Switch;
...
@return This object.*/ setSuggestions(
      suggestions: CardService.Suggestions,
...
Error*/ INTERNAL: Status;
    ...
    /**Unknown error. HTTP Mapping: 500 Internal Server Error*/ UNKNOWN: Status;
  }
  interface SelectionInputType {}
  interface _SelectionInputType {
    ...
    /**A set of switches. Users can turn on one or more switches.*/ SWITCH: SelectionInputType;
  }
...
@param bottomText For multiselect menus, a text description or label that's displayed below the
    item's text field.
@return This object, for chaining.*/ addMultiSelectItem(
      text: Object,
      value: Object,
      selected: boolean,
      startIconUri: Object,
...
@return This object, for chaining.*/ setExternalDataSource(
      action: CardService.Action,
    ): CardService.SelectionInput;
...
@return This object, for chaining.*/ setMultiSelectMaxSelectedItems(
...
@return This object, for chaining.*/ setMultiSelectMinQueryLength(
      queryLength: Integer,
    ): CardService.SelectionInput;
...
@return This object, for chaining.*/ setPlatformDataSource(
      platformDataSource: CardService.PlatformDataSource,
    ): CardService.SelectionInput;
...
@return This object, for chaining.*/ setType(
...
type is `HUMAN`. Text is ignored.*/ UPDATE_USER_MESSAGE_CARDS: ResponseType;
    /**Widget text autocomplete options query.*/ UPDATE_WIDGET: ResponseType;
  }
...
@return This object, for chaining.*/ setCommonDataSource(
      commonDataSource: CardService.CommonDataSource,
    ): CardService.PlatformDataSource;
...
@return This object, for chaining.*/ setHostAppDataSource(
      hostAppDataSource: CardService.HostAppDataSource,
    ): CardService.PlatformDataSource;
  }
...
@return This object, for chaining.*/ setStartIcon(
      icon: CardService.IconImage,
    ): CardService.OverflowMenuItem;
...
@return This object, for chaining.*/ addMenuItem(
      menuItem: CardService.OverflowMenuItem,
    ): CardService.OverflowMenu;
  }
  interface OpenLink {
    /**Sets the behavior of the URL action when the URL window or tab is closed.
@param onClose The closing setting.
@return This object, for chaining.*/ setOnClose(
...
@return This object, for chaining.*/ setOpenAs(
...
@return This object, for chaining.*/ setUrl(url: string): CardService.OpenLink;
  }
  interface OpenAs {}
  interface _OpenAs {
    /**Open in a full window or tab. Default.*/ FULL_SIZE: OpenAs;
    /**Open as an overlay such as a pop-up.*/ OVERLAY: OpenAs;
  }
  interface OnClose {}
  interface _OnClose {
...
@deprecated*/ RELOAD_ADD_ON: OnClose;
  }
...
@return This object, for chaining.*/ popToNamedCard(
      cardName: string,
    ): CardService.Navigation;
    /**Pops the card stack to the root card. Can be chained with other card navigation actions.
@return This object, for chaining.*/ popToRoot(): CardService.Navigation;
    printJson(): string;
...
@return This object, for chaining.*/ pushCard(
...
@return This object, for chaining.*/ updateCard(
      card: CardService.Card,
    ): CardService.Navigation;
  }
...
@return This object, for chaining.*/ setFill(
      fill: boolean,
    ): CardService.MaterialIcon;
...
@return This object, for chaining.*/ setGrade(
      grade: Integer,
    ): CardService.MaterialIcon;
...
@return This object, for chaining.*/ setName(
      name: string,
    ): CardService.MaterialIcon;
...
@return This object, for chaining.*/ setWeight(
      weight: Integer,
    ): CardService.MaterialIcon;
  }
  interface LoadIndicator {}
  interface _LoadIndicator {
    /**Do not use an indicator.*/ NONE: LoadIndicator;
    /**Use a spinner indicator. Default.*/ SPINNER: LoadIndicator;
  }
...
@return This object, for chaining.*/ setLinkPreviewTitle(
      title: string,
    ): CardService.LinkPreview;
...
@return This object, for chaining.*/ setPreviewCard(
      previewCard: CardService.Card,
    ): CardService.LinkPreview;
...
@return This object, for chaining.*/ setBottomLabel(
      text: string,
    ): CardService.KeyValue;
...
@return This object, for chaining.*/ setButton(
...
@return This object, for chaining.*/ setContent(
      text: string,
    ): CardService.KeyValue;
...
@return This object, for chaining.*/ setIconAltText(
      altText: string,
    ): CardService.KeyValue;
...
@return This object, for chaining.*/ setEndIcon(
      endIcon: CardService.IconImage,
    ): CardService.KeyValue;
...
@return This object, for chaining.*/ setStartIcon(
  ...
  interface _ImageCropType {
    ...
    /**Square shape crop style.*/ SQUARE: ImageCropType;
  }
...
@return This object, for chaining.*/ setAspectRatio(
      ratio: number,
    ): CardService.ImageCropStyle;
    /**Sets the crop type for the image. Default is SQUARE.
@param type The crop type.
@return This object, for chaining.*/ setImageCropType(
      type: CardService.ImageCropType,
    ): CardService.ImageCropStyle;
  }
...
@return This object, for chaining.*/ setAltText(
      altText: string,
    ): CardService.ImageComponent;
    /**Sets the border style applied to the image.
@param borderStyle The BorderStyle object to apply.
@return This object, for chaining.*/ setBorderStyle(
      borderStyle: CardService.BorderStyle,
    ): CardService.ImageComponent;
    /**Sets the crop style for the image.
@param imageCropStyle The ImageCropStyle object to apply.
@return This object, for chaining.*/ setCropStyle(
      imageCropStyle: CardService.ImageCropStyle,
    ): CardService.ImageComponent;
    /**Sets the URL of the image.
@param url The URL.
@return This object, for chaining.*/ setImageUrl(
      url: string,
    ): CardService.ImageComponent;
  }
  interface ImageButtonStyle {}
  interface _ImageButtonStyle {
    ...
    /**Image button with clear background.*/ OUTLINED: ImageButtonStyle;
  }
...
@return This object, for chaining.*/ setImageButtonStyle(
      imageButtonStyle: CardService.ImageButtonStyle,
    ): CardService.ImageButton;
    /**Sets the material design icon.
...
@return This object, for chaining.*/ setImageCropType(
      imageCropType: CardService.ImageCropType,
    ): CardService.IconImage;
    /**Sets the material design icon.
...
@return This object, for chaining.*/ setMaterialIcon(
  ...
  interface _Icon {
    ...
    /**![Video play icon](https://www.gstatic.com/images/icons/material/system/1x/play_circle_filled_grey600_48dp.png)*/ VIDEO_PLAY: Icon;
  }
...
@return This object, for chaining.*/ setChatDataSource(
      chatClientDataSource: CardService.ChatClientDataSource,
    ): CardService.HostAppDataSource;
  }
  interface HorizontalSizeStyle {}
  interface _HorizontalSizeStyle {
...
of the column, it doesn't expand to fill the space.*/ FILL_MINIMUM_SPACE: HorizontalSizeStyle;
  }
  ...
  interface _HorizontalAlignment {
    ...
    /**Align the widget to the start of the sentence side.*/ START: HorizontalAlignment;
  }
  interface GridItemLayout {}
  interface _GridItemLayout {
    /**The title and subtitle are shown above the grid item's image.*/ TEXT_ABOVE: GridItemLayout;
    /**The title and subtitle are shown below the grid item's image.*/ TEXT_BELOW: GridItemLayout;
  }
  interface GridItem {
...
@param id The ID.
@return This object, for chaining.*/ setIdentifier(
      id: string,
    ): CardService.GridItem;
    /**Sets the image for this grid item.
@param image The ImageComponent object.
@return This object, for chaining.*/ setImage(
      image: CardService.ImageComponent,
    ): CardService.GridItem;
...
@return This object, for chaining.*/ setLayout(
      layout: CardService.GridItemLayout,
    ): CardService.GridItem;
    /**Sets the subtitle of the grid item.
@param subtitle The subtitle text.
@return This object, for chaining.*/ setSubtitle(
      subtitle: string,
    ): CardService.GridItem;
    /**Sets the horizontal alignment of the grid item. Default is START.
@param alignment The alignment setting.
@return This object, for chaining.*/ setTextAlignment(
      alignment: CardService.HorizontalAlignment,
    ): CardService.GridItem;
...
@return This object, for chaining.*/ setNumColumns(
      numColumns: Integer,
    ): CardService.Grid;
    /**Sets an action that executes when the object is clicked. A UI object can only have one of
...
@param title The title text.
@return This object, for chaining.*/ setTitle(title: string): CardService.Grid;
  }
...
@param button The button to add.
@return This object, for chaining.*/ setPrimaryButton(
...
@param button The button to add.
@return This object, for chaining.*/ setSecondaryButton(
      button: CardService.TextButton,
    ): CardService.FixedFooter;
  }
...
manifest.
@return This object, for chaining.*/ requestFileScopeForActiveDocument(): CardService.EditorFileScopeActionResponseBuilder;
  }
...
@return This object, for chaining.*/ requestFileScope(
      itemId: string,
...
@return This object, for chaining.*/ setActionStatus(
      actionStatus: CardService.ActionStatus,
    ): CardService.DialogAction;
...
@return This object, for chaining.*/ setDialog(
      dialog: CardService.Dialog,
    ): CardService.DialogAction;
  }
  interface Dialog {
    /**Sets the card of the `Dialog`.
...
@return This object, for chaining.*/ setBody(
      card: CardService.Card,
    ): CardService.Dialog;
  }
...
@param switchToSet The switch to add.
@return This object, for chaining.*/ setSwitchControl(
      switchToSet: CardService.Switch,
    ): CardService.DecoratedText;
    /**Sets the text to be used as the value. Supports [basic HTML formatting](/gmail/add-ons/concepts/widgets#text_formatting). Required.
@param text The text content for this widget.
...
@return This object, for chaining.*/ setWrapText(
      wrapText: boolean,
    ): CardService.DecoratedText;
    /**Sets the icon to be used as the key.
@deprecated
...
@return This picker, for chaining.*/ setTimeZoneOffsetInMins(
...
@return This picker, for chaining.*/ setValueInMsSinceEpoch(
      valueMsEpoch: number,
    ): CardService.DateTimePicker;
    /**Sets the prefilled value to be set in the input field.
...
is generated.*/ MUTABLE_HTML: ContentType;
    /**Indicates that the generated content is plain text. Default.*/ TEXT: ContentType;
  }
  interface ComposedEmailType {}
  interface _ComposedEmailType {
    /**A draft that is a reply to another message. Default.*/ REPLY_AS_DRAFT: ComposedEmailType;
    /**A draft that is a standalone message.*/ STANDALONE_DRAFT: ComposedEmailType;
  }
...
@return This object, for chaining.*/ setGmailDraft(
  ...
  interface _CommonDataSource {
    ...
    /**Google Workspace users.*/ USER: CommonDataSource;
  }
  interface Columns {
...
@return This object, for chaining.*/ addColumn(
      column: CardService.Column,
    ): CardService.Columns;
...
@return This object, for chaining.*/ setWrapStyle(
      wrapStyle: CardService.WrapStyle,
    ): CardService.Columns;
  }
  interface Column {
...
@return This object, for chaining.*/ addWidget(
...
@return This object, for chaining.*/ setHorizontalAlignment(
      horizontalAlignment: CardService.HorizontalAlignment,
    ): CardService.Column;
...
@return This object, for chaining.*/ setHorizontalSizeStyle(
      horizontalSizeStyle: CardService.HorizontalSizeStyle,
    ): CardService.Column;
...
@return This object, for chaining.*/ setVerticalAlignment(
      verticalAlignment: CardService.VerticalAlignment,
    ): CardService.Column;
  }
...
@return This object, for chaining.*/ setCollapseButton(
      button: CardService.Button,
    ): CardService.CollapseControl;
...
@return This object, for chaining.*/ setExpandButton(
      button: CardService.Button,
    ): CardService.CollapseControl;
...
@return This object, for chaining.*/ setHorizontalAlign(
      horizontalAlignment: CardService.HorizontalAlignment,
    ): CardService.CollapseControl;
  }
  interface ChipListLayout {}
  interface _ChipListLayout {
    /**The chips scroll horizontally if they don't fit in the available space.*/ HORIZONTAL_SCROLLABLE: ChipListLayout;
    /**The chip list wraps to the next line if there isn't enough horizontal space. Default.*/ WRAPPED: ChipListLayout;
  }
  interface ChipList {
    /**Adds a chip.
@param chip The chip to add.
@return This object, for chaining.*/ addChip(
      chip: CardService.Chip,
    ): CardService.ChipList;
...
@return This object, for chaining.*/ setLayout(
      layout: CardService.ChipListLayout,
    ): CardService.ChipList;
  }
  interface Chip {
...
@return This object, for chaining.*/ setDefaultToCurrentSpace(
      defaultToCurrentSpace: boolean,
    ): CardService.ChatSpaceDataSource;
  }
...
@return This object, for chaining.*/ addCardsV2(
      cardWithId: CardService.CardWithId,
    ): CardService.ChatResponseBuilder;
...
@return This object, for chaining.*/ setActionResponse(
      actionResponse: CardService.ChatActionResponse,
    ): CardService.ChatResponseBuilder;
...
@return This object, for chaining.*/ setSpaceDataSource(
      spaceDataSource: CardService.ChatSpaceDataSource,
    ): CardService.ChatClientDataSource;
  }
...
@return This object, for chaining.*/ setDialogAction(
      dialogAction: CardService.DialogAction,
    ): CardService.ChatActionResponse;
...
@return This object, for chaining.*/ setResponseType(
      responseType: CardService.ResponseType,
    ): CardService.ChatActionResponse;
...
@return This object, for chaining.*/ setUpdatedWidget(
      updatedWidget: CardService.UpdatedWidget,
    ): CardService.ChatActionResponse;
...
@return This object, for chaining.*/ setUrl(
      url: string,
    ): CardService.ChatActionResponse;
  }
...
```
@param card The [`Card`](https://developers.google.com/apps-script/reference/card-service/card.html) to use.
@return This object, for chaining.*/ setCard(
      card: CardService.Card,
    ): CardService.CardWithId;
...
@return This object, for chaining.*/ setCardId(
      id: string,
    ): CardService.CardWithId;
  }
...
@return This object, for chaining.*/ setCollapseControl(
      collapseControl: CardService.CollapseControl,
    ): CardService.CardSection;
    /**Sets whether the section can be collapsed.
@param collapsible The collapsible setting.
@return This object, for chaining.*/ setCollapsible(
      collapsible: boolean,
    ): CardService.CardSection;
    /**Sets the header of the section. Optional.
@param header The header text.
@return This object, for chaining.*/ setHeader(
      header: string,
    ): CardService.CardSection;
...
@return This object, for chaining.*/ setNumUncollapsibleWidgets(
...
@return This object, for chaining.*/ setImageAltText(
      imageAltText: string,
...
@return This object, for chaining.*/ setImageStyle(
...
@return This object, for chaining.*/ addCardAction(
...
@return This object, for chaining.*/ addSection(
...
@return This object, for chaining.*/ setDisplayStyle(
...
@return This object, for chaining.*/ setFixedFooter(
...
@return This object, for chaining.*/ setPeekCardHeader(
...
@return This object, for chaining.*/ addAttachments(
      attachments: CardService.Attachment[],
...
@return This object, for chaining.*/ addAttendees(
      emails: string[],
    ): CardService.CalendarEventActionResponseBuilder;
...
@return This object, for chaining.*/ setConferenceData(
  ...
  interface ButtonSet {
    /**Adds a button.
@param button The button to add.
@return This object, for chaining.*/ addButton(
      button: CardService.Button,
...
@return This object, for chaining.*/ setAuthorizationUrl(
      authUrl: string,
...
@return This object, for chaining.*/ setCustomUiCallback(
      callback: string,
    ): CardService.AuthorizationException;
    /**Sets the name that is displayed to the user when asking for authorization. Required.
@param name The display name.
@return This object, for chaining.*/ setResourceDisplayName(
      name: string,
    ): CardService.AuthorizationException;
    /**Triggers this exception to be thrown.*/ throwException(): void;
  }
...
@return This object, for chaining.*/ setStatusCode(
      statusCode: CardService.Status,
    ): CardService.ActionStatus;
...
@return This object, for chaining.*/ setUserFacingMessage(
      message: string,
    ): CardService.ActionStatus;
  }
...
@return This object, for chaining.*/ setNavigation(
...
@return This object, for chaining.*/ setNotification(
...
@return This object, for chaining.*/ setStateChanged(
...
@return This object, for chaining.*/ addRequiredWidget(
...
@param allWidgetsAreRequired Whether the action requires inputs from all widgets. Defaults to
    `false`.
@return This object, for chaining.*/ setAllWidgetsAreRequired(
...
@return This object, for chaining.*/ setFunctionName(
      functionName: string,
    ): CardService.Action;
...
@return This object, for chaining.*/ setInteraction(
      interaction: CardService.Interaction,
    ): CardService.Action;
    /**Sets the loading indicator that displays while the action is in progress.
@param loadIndicator The indicator to display.
@return This object, for chaining.*/ setLoadIndicator(
      loadIndicator: CardService.LoadIndicator,
    ): CardService.Action;
    setMethodName(functionName: string): CardService.Action;
...
@return This object, for chaining.*/ setParameters(
      parameters: Object,
    ): CardService.Action;
...
@return This object, for chaining.*/ setPersistValues(
