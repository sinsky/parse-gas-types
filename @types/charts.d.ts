...
@return A TextStyleBuilder, which can be used to build a text style configuration object.*/ newTextStyle(): Charts.TextStyleBuilder;
}
module Charts {
...
@return This builder, useful for chaining.*/ setColor(
      cssValue: string,
...
@return This builder, useful for chaining.*/ setFontName(
      fontName: string,
    ): Charts.TextStyleBuilder;
...
@return This builder, useful for chaining.*/ setFontSize(
      fontSize: number,
    ): Charts.TextStyleBuilder;
  }
  interface TextStyle {
...
```
@return The font size in pixels.*/ getFontSize(): number;
  }
...
@return This builder, useful for chaining.*/ setDataSourceUrl(
      url: string,
    ): Charts.TableChartBuilder;
...
@return This builder, useful for chaining.*/ setDataTable(
...
@return This builder, useful for chaining.*/ setDataViewDefinition(
      dataViewDefinition: Charts.DataViewDefinition,
    ): Charts.TableChartBuilder;
    /**Sets the dimensions for the chart.
@param width The width of the chart, in pixels.
@param height The height of the chart, in pixels.
@return This builder, useful for chaining.*/ setDimensions(
      width: Integer,
      height: Integer,
    ): Charts.TableChartBuilder;
...
@return This builder, useful for chaining.*/ setOption(
      option: string,
      value: Object,
    ): Charts.TableChartBuilder;
...
@return This builder, useful for chaining.*/ setCaseSensitive(
...
@return This builder, useful for chaining.*/ setMatchType(
...
@param realtimeTrigger If `true`, sets events to be triggered at real time (when a key is
    pressed).
@return This builder, useful for chaining.*/ setRealtimeTrigger(
...
@return This builder, useful for chaining.*/ setYAxisTitleTextStyle(
  ...
  interface _Position {
    ...
    /**Above the chart.*/ TOP: Position;
  }
  interface PointStyle {}
  interface _PointStyle {
    ...
    /**Use tiny line points.*/ TINY: PointStyle;
  }
...
@return This builder, useful for chaining.*/ setTitleTextStyle(
  ...
  interface PickerValuesLayout {}
  interface _PickerValuesLayout {
    ...
    /**Similar to below, but entries that cannot fit in the picker wrap to a new line.*/ BELOW_WRAPPING: PickerValuesLayout;
  }
  interface Orientation {}
  interface _Orientation {
...
@return This builder, useful for chaining.*/ setMaxValue(
      maxValue: Integer,
...
@return This builder, useful for chaining.*/ setMinValue(
      minValue: Integer,
    ): Charts.NumberRangeFilterBuilder;
...
@return This builder, useful for chaining.*/ setOrientation(
...
@return This builder, useful for chaining.*/ setShowRangeValues(
...
@return This builder, useful for chaining.*/ setTicks(
      ticks: Integer,
    ): Charts.NumberRangeFilterBuilder;
  }
  interface MatchType {}
  interface _MatchType {
    /**Match any substring*/ ANY: MatchType;
    /**Match exact values only*/ EXACT: MatchType;
    /**Match prefixes starting from the beginning of the value*/ PREFIX: MatchType;
  }
...
@return This builder, useful for chaining.*/ useLogScale(): Charts.LineChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): Charts.ColumnChartBuilder;
  }
  interface ChartType {}
  interface _ChartType {
    ...
    /**Waterfall chart.*/ WATERFALL: ChartType;
  }
...
@return The value currently set for the specified option. If the option was not set and the
    default value is available, returns the default value.*/ getOrDefault(
      option: string,
    ): Object;
  }
  interface ChartMergeStrategy {}
  interface _ChartMergeStrategy {
    /**Default. Charts merges the columns of multiple ranges.*/ MERGE_COLUMNS: ChartMergeStrategy;
    /**Charts merges the rows of multiple ranges.*/ MERGE_ROWS: ChartMergeStrategy;
  }
  interface ChartHiddenDimensionStrategy {}
  interface _ChartHiddenDimensionStrategy {
    ...
    /**Charts does not skip hidden columns or hidden rows.*/ SHOW_BOTH: ChartHiddenDimensionStrategy;
  }
  interface Chart {
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): Charts.BarChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): Charts.AreaChartBuilder;
  }
}
const Charts: Charts;
