...
@return This builder, for chaining.*/setNotes(notes:string):ConferenceDataService.ConferenceDataBuilder;}interface ConferenceData{printJson():string;}}const ConferenceDataService:ConferenceDataService;