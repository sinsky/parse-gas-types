...
@param values objects with which to replace substitution strings within the message. This gives
    you additional control over the format of the output.*/ error(
...
@param formatOrObject a string containing zero or more substitution strings, or a JavaScript
    object to be logged as a JavaScript object if no other parameters.
@param values objects with which to replace substitution strings within the message. This gives
    you additional control over the format of the output.*/ info(
    formatOrObject: Object,
    ...values: Object[]
  ): void;
...
@param formatOrObject a string containing zero or more substitution strings, or a JavaScript
    object to be logged as a JavaScript object if no other parameters.
@param values objects with which to replace substitution strings within the message. This gives
    you additional control over the format of the output.*/ log(
    formatOrObject: Object,
    ...values: Object[]
  ): void;
...
@param formatOrObject a string containing zero or more substitution strings, or a JavaScript
    object to be logged as a JavaScript object if no other parameters.
@param values objects with which to replace substitution strings within the message. This gives
    you additional control over the format of the output.*/ warn(
    formatOrObject: Object,
    ...values: Object[]
  ): void;
}
