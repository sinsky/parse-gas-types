interface ContentService {
  MimeType: ContentService._MimeType;
...
@return the new TextOutput object.*/ createTextOutput(
    content: string,
...
@return this TextOutput itself, useful for chaining*/ append(
      addedContent: string,
    ): ContentService.TextOutput;
...
@return the TextOutput object, useful for chaining*/ downloadAsFile(
      filename: string,
    ): ContentService.TextOutput;
...
@param content the content to serve
@return this TextOutput itself, useful for chaining*/ setContent(
      content: string,
    ): ContentService.TextOutput;
    /**Sets the mime type for content that will be served. The default is plain text.
@param mimeType the mime type
@return this TextOutput itself, useful for chaining*/ setMimeType(
  ...
  interface _MimeType {
    ...
    /**VCARD Mime Type*/ VCARD: MimeType;
  }
}
