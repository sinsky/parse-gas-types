...
@return A new [`CommunityConnector`](https://developers.google.com/apps-script/reference/data-studio/community-connector.html) object.*/ createCommunityConnector(): DataStudioApp.CommunityConnector;
}
...
@return This object, for chaining.*/ setDebugText(
      text: string,
...
@return This builder, for chaining.*/ setAllowOverride(
...
@return This builder, for chaining.*/ setId(
      id: string,
    ): DataStudioApp.TextInput;
...
@return This builder, for chaining.*/ setIsDynamic(
      isDynamic: boolean,
    ): DataStudioApp.TextInput;
    /**Sets the display name for this configuration entry.
@param name The name to set.
@return This builder, for chaining.*/ setName(
      name: string,
    ): DataStudioApp.TextInput;
    /**Sets the placeholder text for this configuration entry.
@param placeholder The placeholder text to set.
@return This builder, for chaining.*/ setPlaceholder(
      placeholder: string,
    ): DataStudioApp.TextInput;
  }
  interface TextArea {
...
@return The validated [`SetCredentialsResponse`](https://developers.google.com/apps-script/reference/data-studio/set-credentials-response.html) object.*/ build(): Object;
    printJson(): string;
...
@return This builder, for chaining.*/ setIsValid(
      isValid: boolean,
...
@return This builder, for chaining.*/ addOption(
...
@return This builder, for chaining.*/ setLabel(
      label: string,
...
@return This builder, for chaining.*/ setText(text: string): DataStudioApp.Info;
  }
  interface GetSchemaResponse {
    /**Validates this object and returns it in the format needed by Data Studio.
@return The validated [`GetSchemaResponse`](https://developers.google.com/apps-script/reference/data-studio/get-schema-response.html) object.*/ build(): Object;
    printJson(): string;
    /**Sets the [`Fields`](https://developers.google.com/apps-script/reference/data-studio/fields.html) of the builder.
@param fields The fields to set.
@return This builder, for chaining.*/ setFields(
...
@return This builder, for chaining.*/ addAllRows(
      rows: string[][],
...
@return This builder, for chaining.*/ setFiltersApplied(
      filtersApplied: boolean,
    ): DataStudioApp.GetDataResponse;
  }
  interface GetAuthTypeResponse {
    /**Validates this object and returns it in the format needed by Data Studio.
@return The validated [`GetAuthTypeResponse`](https://developers.google.com/apps-script/reference/data-studio/get-auth-type-response.html) object.*/ build(): Object;
    printJson(): string;
...
@return This builder, for chaining.*/ setAuthType(
...
@return This builder, for chaining.*/ setHelpUrl(
      helpUrl: string,
    ): DataStudioApp.GetAuthTypeResponse;
  }
  interface Fields {
...
@return A new [`Fields`](https://developers.google.com/apps-script/reference/data-studio/fields.html) object.*/ forIds(
      ids: string[],
...
@return The [`Field`](https://developers.google.com/apps-script/reference/data-studio/field.html) with the given ID, or `null` if no such field is contained
    within this [`Fields`](https://developers.google.com/apps-script/reference/data-studio/fields.html) object.*/ getFieldById(
      fieldId: string,
    ): DataStudioApp.Field;
...
@param fieldId The ID of the field to use as the default metric. This ID must be present in the
    set of fields.*/ setDefaultMetric(fieldId: string): void;
  }
  interface FieldType {}
...
20170317023017.*/ YEAR_MONTH_DAY_SECOND: FieldType;
    ...
    /**Year and week in the format of YYYYww such as 201707.*/ YEAR_WEEK: FieldType;
  }
  interface Field {
...
@return This builder, for chaining.*/ setAggregation(
...
@return This builder, for chaining.*/ setDescription(
      description: string,
    ): DataStudioApp.Field;
...
@return This builder, for chaining.*/ setFormula(
      formula: string,
    ): DataStudioApp.Field;
...
@return This builder, for chaining.*/ setGroup(
      group: string,
    ): DataStudioApp.Field;
...
@return This builder, for chaining.*/ setIsHidden(
      isHidden: boolean,
    ): DataStudioApp.Field;
...
@return This builder, for chaining.*/ setIsReaggregatable(
...
@return This builder, for chaining.*/ setType(
...
@return A new text input configuration entry.*/ newTextInput(): DataStudioApp.TextInput;
    printJson(): string;
...
@param dateRangeRequired Whether or not a date range should be provided to `getData()`
    requests.
@return This builder, for chaining.*/ setDateRangeRequired(
...
@return This builder, for chaining.*/ setIsSteppedConfig(
...
@return A new [`UserError`](https://developers.google.com/apps-script/reference/data-studio/user-error.html) object.*/ newUserError(): DataStudioApp.UserError;
  }
  interface Checkbox {
    /**Enables overriding for this config entry. If set to `true`, data source creators have the
option to enable this for report editors.
...
@return This builder, for chaining.*/ setName(
  ...
  interface BigQueryParameterType {}
  interface _BigQueryParameterType {
    ...
    /**String.*/ STRING: BigQueryParameterType;
  }
...
@return This object, for chaining.*/ addQueryParameter(
      name: string,
...
@return This object, for chaining.*/ setAccessToken(
      accessToken: string,
    ): DataStudioApp.BigQueryConfig;
...
@return This object, for chaining.*/ setBillingProjectId(
...
@return This object, for chaining.*/ setQuery(
      query: string,
    ): DataStudioApp.BigQueryConfig;
...
@return This object, for chaining.*/ setUseStandardSql(
  ...
  interface _AuthType {
    ...
    /**Username and token needed.*/ USER_TOKEN: AuthType;
  }
  interface AggregationType {}
  interface _AggregationType {
...
@deprecated*/ NO_AGGREGATION: AggregationType;
    /**Sum.*/ SUM: AggregationType;
  }
}
const DataStudioApp: DataStudioApp;
