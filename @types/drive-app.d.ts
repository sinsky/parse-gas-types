...
@return The new parent of the file added as a child.*/ addFile(
    child: DriveApp.File,
  ): DriveApp.Folder;
...
@return The new parent of the folder added as a child.*/ addFolder(
...
@return A collection of files that remained in a previous iterator when the continuation token
    was generated.*/ continueFileIterator(
...
@return A collection of folders that remained in a previous iterator when the continuation
    token was generated.*/ continueFolderIterator(
    continuationToken: string,
...
@return The new file.*/ createFile(
    name: string,
    content: string,
  ): DriveApp.File;
...
@return The new shortcut.*/ createShortcutForTargetIdAndResourceKey(
    targetId: string,
...
```
@param value The new state of the enforceSingleParent flag.*/ enforceSingleParent(
    value: boolean,
  ): void;
...
@return The file with the given ID.*/ getFileByIdAndResourceKey(
    id: string,
    resourceKey: string,
  ): DriveApp.File;
...
@return A collection of all files in the user's Drive that have the given name.*/ getFilesByName(
    name: string,
  ): DriveApp.FileIterator;
...
@return The folder with the given ID.*/ getFolderById(
    id: string,
  ): DriveApp.Folder;
...
@param id The ID of the folder.
@param resourceKey The resource key of the folder.
@return The folder with the given ID.*/ getFolderByIdAndResourceKey(
    id: string,
    resourceKey: string,
  ): DriveApp.Folder;
...
@return A collection of all folders in the user's Drive that have the given name.*/ getFoldersByName(
    name: string,
  ): DriveApp.FolderIterator;
...
@return The previous parent of the child.*/ removeFile(
    child: DriveApp.File,
  ): DriveApp.Folder;
...
@return The previous parent of the child.*/ removeFolder(
    child: DriveApp.Folder,
  ): DriveApp.Folder;
...
does not support it.*/ VIEW: Permission;
  }
...
remain.
@return the next item in the collection*/ next(): DriveApp.Folder;
  }
  interface Folder {
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ addEditor(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Adds the given user to the list of editors for the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html). If the user was already
on the list of viewers, this method promotes the user out of the list of viewers.
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ addEditors(
...
@param emailAddress The email address of the user to add.
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ addViewer(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Adds the given user to the list of viewers for the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html). If the user was already
on the list of editors, this method has no effect.
...
@param emailAddresses An array of email addresses of the users to add.
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ addViewers(
      emailAddresses: string[],
    ): DriveApp.Folder;
...
@return the permissions granted to the user*/ getAccess(
      email: string,
    ): DriveApp.Permission;
    /**Gets the permission granted to the given user.
...
@param name The name of the files to find.
@return A collection of all files that are children of the current folder and have the given name.*/ getFilesByName(
      name: string,
    ): DriveApp.FileIterator;
...
@param name The name of the folders to find.
@return A collection of all folders that are children of the current folder and have the given name.*/ getFoldersByName(
      name: string,
    ): DriveApp.FolderIterator;
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ moveTo(
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ removeEditor(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Removes the given user from the list of editors for the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html). This method doesn't
block users from accessing the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html) if they belong to a class of users who have
...
@param emailAddress The email address of the user to remove.
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html) for chaining.*/ removeViewer(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Removes the given user from the list of viewers and commenters for the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html). This
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ revokePermissions(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Revokes the access to the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html) granted to the given user. This method doesn't
block users from accessing the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html) if they belong to a class of users who
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setDescription(
      description: string,
    ): DriveApp.Folder;
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setName(
      name: string,
    ): DriveApp.Folder;
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setOwner(
      emailAddress: string,
    ): DriveApp.Folder;
    /**Changes the owner of the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html). This method also gives the previous owner
explicit edit access to the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html).
...
@return This [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining.*/ setSecurityUpdateEnabled(
      enabled: boolean,
    ): DriveApp.Folder;
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setShareableByEditors(
      shareable: boolean,
    ): DriveApp.Folder;
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setSharing(
...
@param starred `true` if the [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html) should be starred in the user's
    Drive; `false` if not
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setStarred(
      starred: boolean,
    ): DriveApp.Folder;
...
@return this [`Folder`](https://developers.google.com/apps-script/reference/drive/folder.html), for chaining*/ setTrashed(
      trashed: boolean,
    ): DriveApp.Folder;
  }
...
@return `true` if [`next()`](https://developers.google.com/apps-script/reference/drive/file-iterator.html#next()) will return an item; `false` if not*/ hasNext(): boolean;
    /**Gets the next item in the collection of files or folders. Throws an exception if no items
remain.
@return the next item in the collection*/ next(): DriveApp.File;
  }
  interface File {
...
```
@param emailAddress The email address of the user to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addCommenter(
      emailAddress: string,
    ): DriveApp.File;
    /**Add the given user to the list of commenters for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). If the user was
already on the list of viewers, this method promotes the user out of the list of viewers.
...
```
@param emailAddresses An array of email addresses of the users to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addCommenters(
      emailAddresses: string[],
    ): DriveApp.File;
...
on the list of viewers, this method promotes the user out of the list of viewers.
@param emailAddress The email address of the user to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addEditor(
      emailAddress: string,
    ): DriveApp.File;
    /**Adds the given user to the list of editors for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). If the user was already
on the list of viewers, this method promotes the user out of the list of viewers.
...
viewers.
@param emailAddresses An array of email addresses of the users to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addEditors(
      emailAddresses: string[],
    ): DriveApp.File;
...
on the list of editors, this method has no effect.
@param emailAddress The email address of the user to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addViewer(
      emailAddress: string,
    ): DriveApp.File;
    /**Adds the given user to the list of viewers for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). If the user was already
on the list of editors, this method has no effect.
...
users were already on the list of editors, this method has no effect for them.
@param emailAddresses An array of email addresses of the users to add.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ addViewers(
      emailAddresses: string[],
    ): DriveApp.File;
    /**Gets the permission granted to the given user.
@param email the email address of the user whose permissions should be checked
...
current parent folder in order to move the item to the destination folder.
@param destination The folder that becomes the new parent.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ moveTo(
      destination: DriveApp.Folder,
    ): DriveApp.File;
...
```
@param emailAddress The email address of the user to remove.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ removeCommenter(
      emailAddress: string,
    ): DriveApp.File;
    /**Removes the given user from the list of commenters for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). This method
does not block users from access the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) if they belong to a class of users
...
For Drive files, this also removes the user from the list of viewers.
@param emailAddress The email address of the user to remove.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ removeEditor(
      emailAddress: string,
    ): DriveApp.File;
    /**Removes the given user from the list of editors for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). This method doesn't
block users from accessing the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) if they belong to a class of users who have
...
For Drive files, this also removes the user from the list of editors.
@param emailAddress The email address of the user to remove.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html) for chaining.*/ removeViewer(
      emailAddress: string,
    ): DriveApp.File;
    /**Removes the given user from the list of viewers and commenters for the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). This
method has no effect if the user is an editor, not a viewer. This method also doesn't block
...
entire domain.
@param emailAddress The email address of the user whose access should be revoked.
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ revokePermissions(
      emailAddress: string,
    ): DriveApp.File;
    /**Revokes the access to the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) granted to the given user. This method doesn't
block users from accessing the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) if they belong to a class of users who
...
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ setContent(
      content: string,
    ): DriveApp.File;
...
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setDescription(
      description: string,
    ): DriveApp.File;
...
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setName(
      name: string,
    ): DriveApp.File;
...
@param emailAddress the email address of the user who should become the new owner
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setOwner(
      emailAddress: string,
    ): DriveApp.File;
    /**Changes the owner of the [`File`](https://developers.google.com/apps-script/reference/drive/file.html). This method also gives the previous owner
explicit edit access to the [`File`](https://developers.google.com/apps-script/reference/drive/file.html).
...
@return This [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining.*/ setSecurityUpdateEnabled(
      enabled: boolean,
    ): DriveApp.File;
...
@param shareable `true` if users with edit permissions should be allowed to share with
    other users or change the permissions; `false` if not
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setShareableByEditors(
      shareable: boolean,
    ): DriveApp.File;
...
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setSharing(
      accessType: DriveApp.Access,
      permissionType: DriveApp.Permission,
    ): DriveApp.File;
...
@param starred `true` if the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) should be starred in the user's
    Drive; `false` if not
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setStarred(
      starred: boolean,
    ): DriveApp.File;
...
@param trashed `true` if the [`File`](https://developers.google.com/apps-script/reference/drive/file.html) should be moved to the trash of
    the user's Drive; `false` if not
@return this [`File`](https://developers.google.com/apps-script/reference/drive/file.html), for chaining*/ setTrashed(
      trashed: boolean,
    ): DriveApp.File;
  }
  interface Access {}
...
an exception.*/ DOMAIN_WITH_LINK: Access;
    /**Only people explicitly granted permission can access. Sign-in required.*/ PRIVATE: Access;
  }
}
