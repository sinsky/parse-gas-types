...
@return the new `HtmlOutput` object*/ createHtmlOutput(
    blob: BlobSource,
...
@return the new `HtmlOutput` object*/ createHtmlOutputFromFile(
    filename: string,
  ): HtmlService.HtmlOutput;
...
```
@param blob The object to get HTML out of.
@return the new `HtmlTemplate` object*/ createTemplate(
    blob: BlobSource,
...
```
@param filename the name of the file to use
@return the new `HtmlTemplate` object*/ createTemplateFromFile(
    filename: string,
  ): HtmlService.HtmlTemplate;
...
module HtmlService {
  interface XFrameOptionsMode {}
  interface _XFrameOptionsMode {
...
mode as the default.*/ DEFAULT: XFrameOptionsMode;
  }
  interface SandboxMode {}
  interface _SandboxMode {
...
of July 6, 2016](/apps-script/guides/support/sunset). All scripts now use `IFRAME` mode.*/ NATIVE: SandboxMode;
  }
...
```
@return the template's raw content*/ getRawContent(): string;
  }
...
@return the name of this meta tag.*/ getName(): string;
  }
...
@return This output, for chaining.*/ addMetaTag(
      name: string,
      content: string,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ append(
      addedContent: string,
    ): HtmlService.HtmlOutput;
...
```
@param addedContent The content to append.
@return This output, for chaining.*/ appendUntrusted(
      addedContent: string,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ setContent(
      content: string,
    ): HtmlService.HtmlOutput;
...
@param iconUrl The URL of the favicon image, with the image extension indicating the image
    type.
@return This output, for chaining.*/ setFaviconUrl(
      iconUrl: string,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ setHeight(
      height: Integer,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ setSandboxMode(
...
@return This output, for chaining.*/ setTitle(
      title: string,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ setWidth(
      width: Integer,
    ): HtmlService.HtmlOutput;
...
@return This output, for chaining.*/ setXFrameOptionsMode(
