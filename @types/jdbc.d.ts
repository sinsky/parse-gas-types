...
@return A JdbcConnection object.*/ getCloudSqlConnection(
    url: string,
  ): Jdbc.JdbcConnection;
  /**Attempts to establish a connection to the given Google Cloud SQL URL.
@param url A database URL of the form `jdbc:google:mysql://subname`.
...
@return A JdbcConnection object.*/ getConnection(
    url: string,
  ): Jdbc.JdbcConnection;
  /**Attempts to establish a connection to the given database URL.
...
@param milliseconds Milliseconds since epoch.
@return A JdbcTimestamp object.*/ newTimestamp(
...
@return A JdbcTimestamp object.*/ parseTimestamp(
    timestamp: string,
  ): Jdbc.JdbcTimestamp;
}
module Jdbc {
...
@return `true` if and only if this timestampe is strictly later than the timestamp
    specified as a parameter; `false` otherwise.*/ after(
...
@return `true` if and only if this timestamp is strictly earlier than the timestamp
    specified as a parameter; `false` otherwise.*/ before(
      when: Jdbc.JdbcTimestamp,
    ): boolean;
    /**For documentation of this method, see [
...
@param hours The hour to set; this object is updated to represent a point in time within the
    ...
    before, as interpreted in the local time zone.*/ setHours(
      hours: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param minutes The minutes to set; this object is updated to represent a point in time within
    ...
    before, as interpreted in the local time zone.*/ setMinutes(
      minutes: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param nanoseconds The new fractional seconds value.*/ setNanos(
      nanoseconds: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param seconds The seconds to set; this object is updated to represent a point in time within
    ...
    as before, as interpreted in the local time zone.*/ setSeconds(
      seconds: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param year The year value to set; the timestamp's year is set to this value plus 1900. This
    ...
    then the new date is treated as if it were on March 1.*/ setYear(
      year: Integer,
    ): void;
  }
  interface JdbcTime {
...
@param milliseconds The time value to set. The value is milliseconds since January 1, 1970,
    00:00:00 GMT, while a negative number is milliseconds before that time.*/ setTime(
      milliseconds: Integer,
    ): void;
  }
...
@return The fully-qualified type name of the SQL structured type that this structure
    represents.*/ getSQLTypeName(): string;
  }
...
@param sql The SQL command to add to this statement, typically an SQL `INSERT` or `UPDATE`.*/ addBatch(
      sql: string,
    ): void;
    /**For documentation of this method, see [
...
@return `true` if the first result is a result set; `false` if it is an update
    count or if there are no results.*/ execute(
      sql: string,
...
@return A result set containing the results of the execution. This is never `null`.*/ executeQuery(
      sql: string,
    ): Jdbc.JdbcResultSet;
    /**For documentation of this method, see [
...
@param autoGeneratedKeys A flag that indicates whether auto-generated keys are made available
    for future retrieval; either `Jdbc.Statement.RETURN_GENERATED_KEYS` or `Jdbc.Statement.NO_GENERATED_KEYS`.
@return Either the row count for for Data Manipulation Language statements, or 0 for statements
    that return nothing.*/ executeUpdate(
      sql: string,
      autoGeneratedKeys: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return `true` if the next result is a result set; `false` otherwise.*/ getMoreResults(
      current: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param name The new cursor name, which must be unique within a connection.*/ setCursorName(
      name: string,
    ): void;
    /**For documentation of this method, see [
...
@param enable If `true`, escape processing is enabled; otherwise it is disabled.*/ setEscapeProcessing(
      enable: boolean,
    ): void;
    /**For documentation of this method, see [
...
@param direction The specified direction to set, which is either `Jdbc.ResultSet.FETCH_FORWARD` or `Jdbc.ResultSet.FETCH_REVERSE`.*/ setFetchDirection(
      direction: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param max The new column byte size limit; a value of zero indicates no limit.*/ setMaxFieldSize(
      max: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param seconds The new query timeout in seconds; a value of 0 indicates no timeout.*/ setQueryTimeout(
      seconds: Integer,
    ): void;
  }
...
@return The name of this savepoint.*/ getSavepointName(): string;
  }
...
@param value The string representation of the XML value to set.*/ setString(
      value: string,
    ): void;
  }
  interface JdbcRowId {
...
@return The bytes representing the `ROWID` represented by this [`JdbcRowId`](https://developers.google.com/apps-script/reference/jdbc/jdbc-row-id.html).*/ getBytes(): Byte[];
  }
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return The fully-qualified name of the class of the designated column's values.*/ getColumnClassName(
      column: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return The maximum number of characters allowed as the width of the designated columns.*/ getColumnDisplaySize(
      column: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The designated column's suggested title, usually specifed by a SQL `AS` clause.
    Returns the same as [`getColumnName(column)`](https://developers.google.com/apps-script/reference/jdbc/jdbc-result-set-meta-data.html#getColumnName(Integer)) if an `AS` is not specified.*/ getColumnLabel(
      column: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return The [SQL
    type](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html) of the designated column.*/ getColumnType(
      column: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The designated column's database-specific type name. Returns the fully-qualifed type
    name if this is a user-defined type.*/ getColumnTypeName(
      column: Integer,
    ): string;
    /**For documentation of this method, see [
...
@return The maximum column size for the given column. For numeric data, this is the maximum
    ...
    where the column size is not applicable.*/ getPrecision(
      column: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The designated columns's number of digits to right of the decimal point. Returns 0 for
    data types where the scale is not applicable.*/ getScale(
      column: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return The table schema of the designated column.*/ getSchemaName(
      column: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return The table name of the designated column, or an empty string if not applicable.*/ getTableName(
      column: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return `true` if the specified column is case-sensitive; `false` otherwise.*/ isCaseSensitive(
      column: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return `true` if the specified column is a cash value; `false` otherwise.*/ isCurrency(
      column: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return The nullability status of the specified column, which is `Jdbc.ResultSetMetaData.columnNoNulls`, `Jdbc.ResultSetMetaData.columnNullable`, or
    `Jdbc.ResultSetMetaData.columnNullableUnknown`.*/ isNullable(
      column: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param column The index of the column to examine (the first column is 1, the second is 2, and
    so on).
@return `true` if a where clause can use the specified column; `false` otherwise.*/ isSearchable(
      column: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if it is possible to write to the designated column; `false`
    otherwise.*/ isWritable(column: Integer): boolean;
  }
...
@return `true` if the cursor is moved to a position in this result set; `false` if
    the cursor is before the first row or after the last row.*/ absolute(
      row: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return The column index of the specified column.*/ findColumn(
      columnLabel: string,
    ): Integer;
    /**For documentation of this method, see [
...
@return The value of the designated column in the current row of this result set as an array.*/ getArray(
      columnIndex: Integer,
    ): Jdbc.JdbcArray;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getBigDecimal(
      columnIndex: Integer,
    ): BigNumber;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The value of the designated column in the current row of this result set as a blob.*/ getBlob(
      columnIndex: Integer,
    ): Jdbc.JdbcBlob;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `false` if the value was SQL `NULL`.*/ getBoolean(
      columnIndex: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getByte(
      columnIndex: Integer,
    ): Byte;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getBytes(
      columnIndex: Integer,
    ): Byte[];
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The value of the designated column in the current row of this result set as a clob.*/ getClob(
      columnIndex: Integer,
    ): Jdbc.JdbcClob;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getDate(
      columnIndex: Integer,
    ): Jdbc.JdbcDate;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getDouble(
      columnIndex: Integer,
    ): number;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getFloat(
      columnIndex: Integer,
    ): number;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getInt(
      columnIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getLong(
      columnIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The column value of the current row.*/ getNClob(
      columnIndex: Integer,
    ): Jdbc.JdbcClob;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The column value of the current row; `null` if the value is SQL `NULL`.*/ getNString(
      columnIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The value of the designated column in the current row of this result set.*/ getObject(
      columnIndex: Integer,
    ): Object;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The column row ID value; `null` if the value is SQL `NULL`.*/ getRowId(
      columnIndex: Integer,
    ): Jdbc.JdbcRowId;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The column value of the current row.*/ getSQLXML(
      columnIndex: Integer,
    ): Jdbc.JdbcSQLXML;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; 0 if the value was SQL `NULL`.*/ getShort(
      columnIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getString(
      columnIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getTime(
      columnIndex: Integer,
    ): Jdbc.JdbcTime;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve (the first column is 1, the second is 2,
    and so on).
@return The column value; `null` if the value was SQL `NULL`.*/ getTimestamp(
      columnIndex: Integer,
    ): Jdbc.JdbcTimestamp;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to retrieve the data from (the first column is 1,
    the second is 2, and so on).
@return The URL value of the designated column in the current row of this result set.*/ getURL(
      columnIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@return `true` if the cursor is on a row; `false` otherwise.*/ relative(
      rows: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateArray(
      columnIndex: Integer,
      x: Jdbc.JdbcArray,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateBigDecimal(
      columnIndex: Integer,
      x: BigNumber,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateBlob(
      columnIndex: Integer,
      x: Jdbc.JdbcBlob,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateBoolean(
      columnIndex: Integer,
      x: boolean,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateByte(
      columnIndex: Integer,
      x: Byte,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateBytes(
      columnIndex: Integer,
      x: Byte[],
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateClob(
      columnIndex: Integer,
      x: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateDate(
      columnIndex: Integer,
      x: Jdbc.JdbcDate,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateDouble(
      columnIndex: Integer,
      x: number,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateFloat(
      columnIndex: Integer,
      x: number,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateInt(
      columnIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateLong(
      columnIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateNClob(
      columnIndex: Integer,
      x: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateNString(
      columnIndex: Integer,
      x: string,
    ): void;
    /**For documentation of this method, see [
...
@param columnLabel The label for the column, specified with the SQL AS clause. If the AS clause
    wasn't specified, then the label is the name of the column.*/ updateNull(
      columnLabel: string,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateObject(
      columnIndex: Integer,
      x: Object,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateRef(
      columnIndex: Integer,
      x: Jdbc.JdbcRef,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateRowId(
      columnIndex: Integer,
      x: Jdbc.JdbcRowId,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateSQLXML(
      columnIndex: Integer,
      x: Jdbc.JdbcSQLXML,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateShort(
      columnIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateString(
      columnIndex: Integer,
      x: string,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateTime(
      columnIndex: Integer,
      x: Jdbc.JdbcTime,
    ): void;
    /**For documentation of this method, see [
...
@param columnIndex The index of the column to update (the first column is 1, the second is 2,
    and so on).
@param x The new column value.*/ updateTimestamp(
      columnIndex: Integer,
...
@return `true` if the last column read was SQL `NULL`; `false` otherwise.*/ wasNull(): boolean;
  }
  interface JdbcRef {
    /**For documentation of this method, see [
...
@param object The object to set as the refernence target.*/ setObject(
      object: Object,
    ): void;
  }
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setArray(
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setBigDecimal(
      parameterIndex: Integer,
      x: BigNumber,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setBlob(
      parameterIndex: Integer,
      x: Jdbc.JdbcBlob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setBoolean(
      parameterIndex: Integer,
      x: boolean,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setByte(
      parameterIndex: Integer,
      x: Byte,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setBytes(
      parameterIndex: Integer,
      x: Byte[],
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setClob(
      parameterIndex: Integer,
      x: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setDate(
      parameterIndex: Integer,
      x: Jdbc.JdbcDate,
    ): void;
    /**For documentation of this method, see [
...
@param timeZone A time zone string used to construct [
    ...
    of time zone strings are recognized: short IDs (such as `PST`, `EST`, and
    `GMT`), long IDs (such as `US/Pacific` and `America/Los_Angeles`), and
    offsets (such as `GMT+6:30`).*/ setDate(
      parameterIndex: Integer,
      x: Jdbc.JdbcDate,
      timeZone: string,
    ): void;
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setDouble(
      parameterIndex: Integer,
      x: number,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setFloat(
      parameterIndex: Integer,
      x: number,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setInt(
      parameterIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setLong(
      parameterIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setNClob(
      parameterIndex: Integer,
      x: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setNString(
      parameterIndex: Integer,
      x: string,
    ): void;
    /**For documentation of this method, see [
...
@param sqlType The [SQL
    type](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html) of the specified parameter.*/ setNull(
      parameterIndex: Integer,
      sqlType: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param typeName The fully-qualifed name of an SQL user-defined type. Ignored if the parameter
    isn't a user-defined type or `REF`.*/ setNull(
      parameterIndex: Integer,
      sqlType: Integer,
      typeName: string,
    ): void;
...
@param index The index of the parameter to set (the first parameter is 1, the second is 2, and
    so on).
@param x The object containing the value to set the parameter to.*/ setObject(
      index: Integer,
      x: Object,
    ): void;
    /**For documentation of this method, see [
...
@param scaleOrLength The number of digits after the decimal for `DECIMAL` or `NUMERIC` types, or the length of data for `InputStream` or `Reader` types.
    Ignored for all other types.*/ setObject(
      parameterIndex: Integer,
      x: Object,
      targetSqlType: Integer,
      scaleOrLength: Integer,
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The SQL `REF` value to set.*/ setRef(
      parameterIndex: Integer,
      x: Jdbc.JdbcRef,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setRowId(
      parameterIndex: Integer,
      x: Jdbc.JdbcRowId,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setSQLXML(
      parameterIndex: Integer,
      x: Jdbc.JdbcSQLXML,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setShort(
      parameterIndex: Integer,
      x: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setString(
      parameterIndex: Integer,
      x: string,
    ): void;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setTime(
      parameterIndex: Integer,
      x: Jdbc.JdbcTime,
    ): void;
    /**For documentation of this method, see [
...
@param timeZone A time zone string used to construct [
    ...
    of time zone strings are recognized: short IDs (such as `PST`, `EST`, and
    `GMT`), long IDs (such as `US/Pacific` and `America/Los_Angeles`), and
    offsets (such as `GMT+6:30`).*/ setTime(
      parameterIndex: Integer,
      x: Jdbc.JdbcTime,
      timeZone: string,
    ): void;
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setTimestamp(
      parameterIndex: Integer,
      x: Jdbc.JdbcTimestamp,
    ): void;
    /**For documentation of this method, see [
...
@param timeZone A time zone string used to construct [
    ...
    of time zone strings are recognized: short IDs (such as `PST`, `EST`, and
    `GMT`), long IDs (such as `US/Pacific` and `America/Los_Angeles`), and
    offsets (such as `GMT+6:30`).*/ setTimestamp(
      parameterIndex: Integer,
      x: Jdbc.JdbcTimestamp,
      timeZone: string,
    ): void;
...
@param parameterIndex The index of the parameter to set (the first parameter is 1, the second
    is 2, and so on).
@param x The parameter value to set.*/ setURL(
      parameterIndex: Integer,
      x: string,
    ): void;
  }
...
@return The fully-qualified Java class name that is used by the [`JdbcPreparedStatement.setObject(index, x)`](https://developers.google.com/apps-script/reference/jdbc/jdbc-prepared-statement.html#setObject(Integer,Object)) methods.*/ getParameterClassName(
      param: Integer,
    ): string;
    /**For documentation of this method, see [
...
@return The designated parameter's mode, which is one of `Jdbc.ParameterMetaData.parameterModeIn`, `Jdbc.ParameterMetaData.parameterModeOut`,
    `Jdbc.ParameterMetaData.parameterModeInOut`, or `Jdbc.ParameterMetaData.parameterModeUnknown`.*/ getParameterMode(
      param: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param param The index of the parameter to examine. The first parameter has an index of 1.
@return The designated parameter's [SQL type](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html).*/ getParameterType(
      param: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The designated parameter's database-specific type name. This is a fully-qualified type
    name if the parameter is a user-defined type.*/ getParameterTypeName(
      param: Integer,
    ): string;
    /**For documentation of this method, see [
...
@return The designated parameter's number of digits to right of the decimal point. Returns 0
    for data types where the scale is not applicable.*/ getScale(
      param: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The nullability status of the given parameter; one of `Jdbc.ParameterMetaData.parameterNoNulls`, `Jdbc.ParameterMetaData.parameterNullable`,
    or `Jdbc.ParameterMetaData.parameterNullableUnknown`.*/ isNullable(
      param: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return `true` if the specified parameter can accept signed number values; `false`
    otherwise.*/ isSigned(param: Integer): boolean;
  }
  interface JdbcDate {
    /**For documentation of this method, see [
`java.sql.Date#after(date)`](https://docs.oracle.com/javase/6/docs/api/java/util/Date.html#after(java.util.Date)).
@param when A date to compare to.
@return `true` if and only if this date is strictly later than the provided date; `false` otherwise.*/ after(
      when: Jdbc.JdbcDate,
    ): boolean;
    /**For documentation of this method, see [
`java.sql.Date#before(date)`](https://docs.oracle.com/javase/6/docs/api/java/util/Date.html#before(java.util.Date)).
...
@param date The day of the month to set. The value is between 1 and 31, modified as needed. For
    ...
    treated as if it were on May 1, because April has only 30 days.*/ setDate(
      date: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param milliseconds The number of milliseconds since January 1, 1970, 00:00:00 GMT, not to
    ...
    number of milliseconds before January 1, 1970, 00:00:00 GMT.*/ setTime(
      milliseconds: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param year The value to set the year with. This value plus 1900 is the resulting year the date
    has after this method executes.*/ setYear(year: Integer): void;
  }
...
@return A result set containing descriptions the attributes for a specified user-defined type
    ...
    `ORDINAL_POSITION`.*/ getAttributes(
      catalog: string,
...
@return A result set containing the column descriptions that uniquely identify a row (one
    column description per row in the result set, ordered by `SCOPE`).*/ getBestRowIdentifier(
      catalog: string,
      schema: string,
      table: string,
      scope: Integer,
...
@return A result set containing the column privilege descriptions, one per row, ordered by
    `COLUMN_NAME` and `PRIVILEGE`.*/ getColumnPrivileges(
      catalog: string,
      schema: string,
      table: string,
...
@return A result set containing the column descriptions, one per row, ordered according to
    `TABLE_CAT`, `TABLE_SCHEM`, `TABLE_NAME`, and `ORDINAL_POSITION`.*/ getColumns(
      catalog: string,
      schemaPattern: string,
...
@return An result set containing the foreign key column descriptions for the primary key
    ...
    set, and they are ordered by `FKTABLE_CAT`, `FKTABLE_SCHEM`, `FKTABLE_NAME`, and `KEY_SEQ`.*/ getExportedKeys(
      catalog: string,
      schema: string,
      table: string,
    ): Jdbc.JdbcResultSet;
...
@return A result set containing the descriptions of system and user function parameters
    ...
    `SPECIFIC_ NAME`.*/ getFunctionColumns(
      catalog: string,
      schemaPattern: string,
...
@return A result set containing descriptions of the system and user functions available in the
    given catalog. Each row contains one function description, ordered according to `FUNCTION_CAT`, `FUNCTION_SCHEM`, `FUNCTION_NAME`, and `SPECIFIC_ NAME`.*/ getFunctions(
      catalog: string,
      schemaPattern: string,
      functionNamePattern: string,
    ): Jdbc.JdbcResultSet;
...
@return An result set containing the column descriptions for the primary key columns referenced
    ...
    description is provided in each row of the result set, and they are ordered by `PKTABLE_CAT`, `PKTABLE_SCHEM`, `PKTABLE_NAME`, and `KEY_SEQ`.*/ getImportedKeys(
      catalog: string,
      schema: string,
      table: string,
    ): Jdbc.JdbcResultSet;
...
@return An result set containing the index and statistic column descriptions for the specified
    ...
    ordered by `NON_UNIQUE`, `TYPE`, `INDEX_NAME`, and `ORDINAL_POSITION`.*/ getIndexInfo(
      catalog: string,
      schema: string,
      table: string,
      unique: boolean,
...
@return An result set containing the column descriptions for the primary key columns, one per
    row, ordered by `COLUMN_NAME`.*/ getPrimaryKeys(
      catalog: string,
      schema: string,
      table: string,
    ): Jdbc.JdbcResultSet;
...
@param columnNamePattern The column name pattern to filter the search by. It must match the
    column name as it is stored in the database.
@return A result set containing the procedure and column descriptions, one per row.*/ getProcedureColumns(
      catalog: string,
      schemaPattern: string,
...
@param procedureNamePattern The procedure name pattern to filter the search by. It must match
    the procedure name as it is stored in the database.
@return A result set containing the procedure descriptions, one per row.*/ getProcedures(
      catalog: string,
      schemaPattern: string,
      procedureNamePattern: string,
    ): Jdbc.JdbcResultSet;
...
@return A result set containing scheme descriptions available in this database, ordered by
    `TABLE_CATALOG` and `TABLE_SCHEM`.*/ getSchemas(
      catalog: string,
      schemaPattern: string,
    ): Jdbc.JdbcResultSet;
    /**For documentation of this method, see [
...
@return A result set containing descriptions of the user-defined type hierarchies defined in a
    ...
    user-defined type. Types without supers aren't listed.*/ getSuperTypes(
      catalog: string,
      schemaPattern: string,
      typeNamePattern: string,
    ): Jdbc.JdbcResultSet;
...
@return A result set containing the table privilege descriptions, one per row, ordered by
    `TABLE_CAT`, `TABLE_SCHEM`, `TABLE_NAME`, and `PRIVILEGE`.*/ getTablePrivileges(
      catalog: string,
      schemaPattern: string,
      tableNamePattern: string,
    ): Jdbc.JdbcResultSet;
...
@return A result set containing the table descriptions, one per row, ordered according to
    `TABLE_TYPE`, `TABLE_CAT`, `TABLE_SCHEM`, and `TABLE_NAME`.*/ getTables(
      catalog: string,
      schemaPattern: string,
      tableNamePattern: string,
      types: string[],
...
@return A result set containing the user-defined type (UDT) descriptions, one per row, ordered
    according to `DATA_TYPE`, `TYPE_CAT`, `TYPE_SCHEM`, and `TYPE_NAME`.*/ getUDTs(
      catalog: string,
      schemaPattern: string,
      typeNamePattern: string,
      types: Integer[],
...
@return An unordered result set containing the column descriptions that are updated when any
    value in a row is updated (one column description per row in the result set).*/ getVersionColumns(
      catalog: string,
      schema: string,
      table: string,
    ): Jdbc.JdbcResultSet;
...
@return `true` if for the specified result set type a visible row insert is detected by
    calls to [`JdbcResultSet.rowInserted()`](https://developers.google.com/apps-script/reference/jdbc/jdbc-result-set.html#rowInserted()); `false` otherwise.*/ insertsAreDetected(
      type: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param type The result set type, which is `Jdbc.ResultSet.TYPE_FORWARD_ONLY`, `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`, or `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`.
@return `true` if for the given result set type the set's own deletes are visible; `false` otherwise.*/ ownDeletesAreVisible(
      type: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param type The result set type, which is `Jdbc.ResultSet.TYPE_FORWARD_ONLY`, `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`, or `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`.
@return `true` if for the given result set type the set's own inserts are visible; `false` otherwise.*/ ownInsertsAreVisible(
      type: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@param type The result set type, which is `Jdbc.ResultSet.TYPE_FORWARD_ONLY`, `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`, or `Jdbc.ResultSet.TYPE_SCROLL_INSENSITIVE`.
@return `true` if for the given result set type the set's own updates are visible; `false` otherwise.*/ ownUpdatesAreVisible(
      type: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if this database supports the JDBC scalar function `CONVERT` for the
    conversion of the specified JDBC types; `false` otherwise.*/ supportsConvert(
      fromType: Integer,
      toType: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if this database supports the specified result set and concurrency type
    combination; `false` otherwise.*/ supportsResultSetConcurrency(
      type: Integer,
      concurrency: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if the database the specified holdability; `false` otherwise.*/ supportsResultSetHoldability(
      holdability: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if this database supports the given transaction isolation level; `false` otherwise.*/ supportsTransactionIsolationLevel(
      level: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if for the specified result set type a visible row update is detected by
    calls to [`JdbcResultSet.rowUpdated()`](https://developers.google.com/apps-script/reference/jdbc/jdbc-result-set.html#rowUpdated()); `false` otherwise.*/ updatesAreDetected(
      type: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return `true` if the database stores tables in a local file; `false` otherwise.*/ usesLocalFiles(): boolean;
  }
...
@return An array whose elements map to the specified SQL type.*/ createArrayOf(
      typeName: string,
      elements: Object[],
    ): Jdbc.JdbcArray;
...
@return A statement instance to execute queries with.*/ createStatement(
...
@return `true` if the connection is valid; `false` otherwise. Also returns `false` if the timeout period expires before the operation completes.*/ isValid(
      timeout: Integer,
    ): boolean;
    /**For documentation of this method, see [
...
@return The native form of the provided statement.*/ nativeSQL(
      sql: string,
    ): string;
    /**For documentation of this method, see [
...
@return A callable statement containing the pre-compiled SQL statement.*/ prepareCall(
      sql: string,
...
@return A callable statement containing the pre-compiled SQL statement that produces result
    sets with the provided type and concurrency.*/ prepareCall(
      sql: string,
      resultSetType: Integer,
      resultSetConcurrency: Integer,
    ): Jdbc.JdbcCallableStatement;
...
@param resultSetHoldability A holdability setting; either `Jdbc.ResultSet.HOLD_CURSORS_OVER_COMMIT` or `Jdbc.ResultSet.CLOSE_CURSORS_AT_COMMIT`.
@return A callable statement containing the pre-compiled SQL statement that produces result
    sets with the provided type, concurrency.*/ prepareCall(
      sql: string,
      resultSetType: Integer,
      resultSetConcurrency: Integer,
      resultSetHoldability: Integer,
...
@return A prepared statement containing the pre-compiled SQL statement.*/ prepareStatement(
      sql: string,
...
@return A prepared statement containing the pre-compiled SQL statement, possibly capable of
    returning auto-generated keys.*/ prepareStatement(
      sql: string,
      autoGeneratedKeys: Integer,
    ): Jdbc.JdbcPreparedStatement;
    /**For documentation of this method, see [
...
@return A prepared statement containing the pre-compiled SQL statement that produces result
    sets with the provided type and concurrency.*/ prepareStatement(
      sql: string,
      resultSetType: Integer,
      resultSetConcurrency: Integer,
    ): Jdbc.JdbcPreparedStatement;
...
@param resultSetHoldability A holdability setting; either `Jdbc.ResultSet.HOLD_CURSORS_OVER_COMMIT` or `Jdbc.ResultSet.CLOSE_CURSORS_AT_COMMIT`.
@return A prepared statement containing the pre-compiled SQL statement that produces result
    sets with the provided type, concurrency, and holdability.*/ prepareStatement(
      sql: string,
      resultSetType: Integer,
      resultSetConcurrency: Integer,
      resultSetHoldability: Integer,
...
@return A prepared statement containing the pre-compiled SQL statement, capable of returning
    auto-generated keys specified by the provided column indices.*/ prepareStatementByIndex(
      sql: string,
      indices: Integer[],
    ): Jdbc.JdbcPreparedStatement;
    /**For documentation of this method, see [
...
@return A prepared statement containing the pre-compiled SQL statement, capable of returning
    auto-generated keys specified by the provided column names.*/ prepareStatementByName(
      sql: string,
      columnNames: string[],
    ): Jdbc.JdbcPreparedStatement;
    /**For documentation of this method, see [
...
@param savepoint The save point to remove.*/ releaseSavepoint(
...
@param savepoint The save point to rollback to.*/ rollback(
      savepoint: Jdbc.JdbcSavepoint,
    ): void;
    /**For documentation of this method, see [
...
@param autoCommit If `true`, auto-commit mode is enabled; `false` disables.*/ setAutoCommit(
      autoCommit: boolean,
    ): void;
    /**For documentation of this method, see [
...
@param holdability The default holdability of [`JdbcResultSet`](https://developers.google.com/apps-script/reference/jdbc/jdbc-result-set.html) objects created with this
    connection; either `Jdbc.ResultSet.HOLD_CURSORS_OVER_COMMIT` or `Jdbc.ResultSet.CLOSE_CURSORS_AT_COMMIT`.*/ setHoldability(
      holdability: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param readOnly If `true`, read-only mode is enabled; `false` disables.*/ setReadOnly(
      readOnly: boolean,
    ): void;
    /**For documentation of this method, see [
...
@return The new named save point.*/ setSavepoint(
      name: string,
    ): Jdbc.JdbcSavepoint;
    /**For documentation of this method, see [
...
@param level The transaction level to set, which is one of: `Jdbc.Connection.TRANSACTION_READ_UNCOMMITTED`, `Jdbc.Connection.TRANSACTION_READ_COMMITTED`, `Jdbc.Connection.TRANSACTION_REPEATABLE_READ`, `Jdbc.Connection.TRANSACTION_SERIALIZABLE`, or `Jdbc.Connection.TRANSACTION_NONE`.*/ setTransactionIsolation(
      level: Integer,
    ): void;
  }
  interface JdbcClob {
...
@return The retrieved substring.*/ getSubString(
      position: Integer,
      length: Integer,
    ): string;
    /**For documentation of this method, see [
...
@return The position at which the specifed clob appears, or -1 if it is not present.*/ position(
...
@param start The position at which to begin searching; the first position is 1.
@return The position at which the specifed substring appears, or -1 if it is not present.*/ position(
      search: string,
      start: Integer,
    ): Integer;
...
@return The number of characters written.*/ setString(
      position: Integer,
...
@param length The size (in bytes) of this clob after truncation.*/ truncate(
      length: Integer,
    ): void;
  }
...
@return The value of a `ARRAY` parameter. Returns `null` if the value is `null`.*/ getArray(
      parameterIndex: Integer,
    ): Jdbc.JdbcArray;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter.
@return The value of a `NUMERIC` parameter. Returns `null` if the value is `null`.*/ getBigDecimal(
      parameterName: string,
    ): BigNumber;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `BLOB` parameter. Returns `null` if the value is `null`.*/ getBlob(
      parameterIndex: Integer,
    ): Jdbc.JdbcBlob;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `TINYINT` parameter. Returns 0 if the value is `null`.*/ getByte(
      parameterIndex: Integer,
    ): Byte;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `CLOB` parameter. Returns `null` if the value is `null`.*/ getClob(
      parameterIndex: Integer,
    ): Jdbc.JdbcClob;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `DATE` parameter. Returns `null` if the value is `null`.*/ getDate(
      parameterIndex: Integer,
    ): Jdbc.JdbcDate;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `DOUBLE` parameter. Returns 0 if the value is `null`.*/ getDouble(
      parameterIndex: Integer,
    ): number;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `FLOAT` parameter. Returns 0 if the value is `null`.*/ getFloat(
      parameterIndex: Integer,
    ): number;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `INTEGER` parameter. Returns 0 if the value is `null`.*/ getInt(
      parameterIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `BIGINT` parameter. Returns 0 if the value is `null`.*/ getLong(
      parameterIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@return The value of a `NCLOB` parameter. Returns `null` if the value is `null`.*/ getNClob(
      parameterIndex: Integer,
    ): Jdbc.JdbcClob;
    /**For documentation of this method, see [
...
@param parameterIndex An index indicating which paramater to register (the first parameter is
    1, the second is 2, and so on).
@return A string that maps a `NCHAR`, `NVARCHAR`, or `LONGNVARCHAR` value.*/ getNString(
      parameterIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return An object holding the parameter value.*/ getObject(
      parameterIndex: Integer,
    ): Object;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `REF` parameter. Returns `null` if the value is `null`.*/ getRef(
      parameterIndex: Integer,
    ): Jdbc.JdbcRef;
    /**For documentation of this method, see [
...
@param parameterIndex An index indicating which paramater to register (the first parameter is
    1, the second is 2, and so on).
@return The `ROWID` value. Returns `null` if the parameter contains an SQL `NULL`.*/ getRowId(
      parameterIndex: Integer,
    ): Jdbc.JdbcRowId;
    /**For documentation of this method, see [
...
@param parameterIndex An index indicating which paramater to register (the first parameter is
    1, the second is 2, and so on).
@return A SQLXML object that maps to an SQL XML value.*/ getSQLXML(
      parameterIndex: Integer,
    ): Jdbc.JdbcSQLXML;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `SMALLINT` parameter. Returns 0 if the value is `null`.*/ getShort(
      parameterIndex: Integer,
    ): Integer;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `CHAR`, `VARCHAR`, or `LONGVARCHAR` parameter.*/ getString(
      parameterIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `TIME` parameter. Returns `null` if the value is `null`.*/ getTime(
      parameterIndex: Integer,
    ): Jdbc.JdbcTime;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `TIMESTAMP` parameter. Returns `null` if the value is `null`.*/ getTimestamp(
      parameterIndex: Integer,
    ): Jdbc.JdbcTimestamp;
    /**For documentation of this method, see [
...
@param parameterIndex The index of the parameter to retrieve (the first parameter is 1, the
    second is 2, and so on).
@return The value of a `DATALINK` parameter as a string.*/ getURL(
      parameterIndex: Integer,
    ): string;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter.
@return The value of a `DATALINK` parameter. Returns `null` if the value is `null`.*/ getURL(
      parameterName: string,
    ): string;
    /**For documentation of this method, see [
`java.sql.Statement#getUpdateCount()`](https://docs.oracle.com/javase/6/docs/api/java/sql/Statement.html#getUpdateCount()).
...
@param sqlType The JDBC [type code](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html) to
    ...
    use [`registerOutParameter(parameterIndex, sqlType, scale)`](https://developers.google.com/apps-script/reference/jdbc/jdbc-callable-statement.html#registerOutParameter(Integer,Integer,Integer)) instead.*/ registerOutParameter(
      parameterIndex: Integer,
      sqlType: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param typeName The fully-qualified name of an SQL structured type.*/ registerOutParameter(
      parameterIndex: Integer,
      sqlType: Integer,
      typeName: string,
    ): void;
...
@param sqlType A [type
    code](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html) value.*/ registerOutParameter(
      parameterName: string,
      sqlType: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param scale The desired number of digits to the right of the decimal point, which must be zero
    or greater.*/ registerOutParameter(
      parameterName: string,
      sqlType: Integer,
      scale: Integer,
    ): void;
...
@param parameterName The name of the parameter to set.
@param x A blob that maps to an SQL `BLOB` value.*/ setBlob(
      parameterName: string,
      x: Jdbc.JdbcBlob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter to set.
@param x A clob that maps to an SQL `CLOB` value.*/ setClob(
      parameterName: string,
      x: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter to set.
@param value The parameter value to set.*/ setNClob(
      parameterName: string,
      value: Jdbc.JdbcClob,
    ): void;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter to set.
@param value The parameter value to set.*/ setNString(
      parameterName: string,
      value: string,
    ): void;
    /**For documentation of this method, see [
...
@param parameterName The name of the parameter to set.
@param sqlType The SQL [
    type code](https://docs.oracle.com/javase/6/docs/api/java/sql/Types.html).*/ setNull(
      parameterName: string,
      sqlType: Integer,
    ): void;
    /**For documentation of this method, see [
...
@param typeName The fully-qualified name of an SQL user-defined type; ignored if the parameter
    is not a user-defined type or SQL `REF` value.*/ setNull(
      parameterName: string,
      sqlType: Integer,
      typeName: string,
    ): void;
...
@param parameterName The name of the parameter to set.
@param x The object containing the value to set.*/ setObject(
      parameterName: string,
      x: Object,
    ): void;
    /**For documentation of this method, see [
...
@param scale The number of digits after the decimal point for `DECIMAL` and `NUMERIC` types. Ignored for all other types.*/ setObject(
      parameterName: string,
      x: Object,
      targetSqlType: Integer,
      scale: Integer,
...
@param parameterName The name of the parameter to set.
@param xmlObject A SQLXML object that maps to an SQL XML value.*/ setSQLXML(
      parameterName: string,
...
@param parameterName The name of the parameter to set.
@param val The parameter value to set.*/ setURL(
      parameterName: string,
      val: string,
    ): void;
    /**For documentation of this method, see [
...
@return The number of bytes written.*/ setBytes(
      position: Integer,
      blobSource: BlobSource,
    ): Integer;
    /**Convenience method for writing a [`JdbcBlob`](https://developers.google.com/apps-script/reference/jdbc/jdbc-blob.html) to this blob.
...
@param length The size (in bytes) of this blob after truncation.*/ truncate(
      length: Integer,
    ): void;
  }
  interface JdbcArray {
...
@return An object containing up to the specified number of consecutive SQL array elements.*/ getArray(
      index: Integer,
      count: Integer,
    ): Object;
    /**For documentation of this method, see [
