...
@return the presentation with the given name.*/ create(
    name: string,
...
@return the presentation with the given ID*/ openById(
    id: string,
  ): SlidesApp.Presentation;
...
If the presentation is already open, the same presentation instance is returned.
@return the presentation with the given URL*/ openByUrl(
    url: string,
  ): SlidesApp.Presentation;
}
module SlidesApp {
...
@return This page element, for chaining.*/ alignOnPage(
...
@return This page element, for chaining.*/ preconcatenateTransform(
...
@return This page element, for chaining.*/ scaleHeight(
      ratio: number,
    ): SlidesApp.WordArt;
...
@return This page element, for chaining.*/ scaleWidth(
      ratio: number,
    ): SlidesApp.WordArt;
...
@param replace If `true`, the selection replaces any previous selection; otherwise the
    selection is added to any previous selection.*/ select(
      replace: boolean,
    ): void;
...
@return This page element.*/ setDescription(
      description: string,
    ): SlidesApp.WordArt;
...
@return This page element, for chaining.*/ setHeight(
      height: number,
    ): SlidesApp.WordArt;
...
@return This page element, for chaining.*/ setLeft(
      left: number,
    ): SlidesApp.WordArt;
...
@return the [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) that was set*/ setLinkSlide(
      slideIndex: Integer,
    ): SlidesApp.Link;
...
@return the [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) that was set*/ setLinkUrl(
      url: string,
    ): SlidesApp.Link;
...
@return This page element, for chaining.*/ setRotation(
      angle: number,
    ): SlidesApp.WordArt;
...
@return This page element, for chaining.*/ setTop(
      top: number,
    ): SlidesApp.WordArt;
...
@return This element, for chaining.*/ setTransform(
      transform: SlidesApp.AffineTransform,
    ): SlidesApp.WordArt;
...
@return This page element, for chaining.*/ setWidth(
      width: number,
    ): SlidesApp.WordArt;
  }
  interface VideoSourceType {}
  interface _VideoSourceType {
    /**A video source type that is not supported.*/ UNSUPPORTED: VideoSourceType;
    /**YouTube video.*/ YOUTUBE: VideoSourceType;
  }
  interface Video {
    /**Aligns the element to the specified alignment position on the page.
@param alignmentPosition The position to align this page element to on the page.
...
@return The color type.*/ getColorType(): ColorType;
    /**Get the theme color type of this color.*/ getThemeColorType(): SlidesApp.ThemeColorType;
  }
  interface TextStyle {
...
```*/ removeLink(): SlidesApp.TextStyle;
    /**Sets the background color of the text to the given RGB values from 0 to 255.*/ setBackgroundColor(
      red: Integer,
      green: Integer,
      blue: Integer,
    ): SlidesApp.TextStyle;
    /**Sets the background color of the text.*/ setBackgroundColor(
      color: SlidesApp.Color,
    ): SlidesApp.TextStyle;
    /**Sets the background color of the text to the given [`ThemeColorType`](https://developers.google.com/apps-script/reference/slides/theme-color-type.html).*/ setBackgroundColor(
...
'#FFC0CB'.*/ setBackgroundColor(hexColor: string): SlidesApp.TextStyle;
    ...
    /**Sets the vertical offset of the text relative to its normal position.*/ setBaselineOffset(
      offset: SlidesApp.TextBaselineOffset,
    ): SlidesApp.TextStyle;
    /**Sets whether the text should be rendered as bold.

Changing the text's boldness updates the font weight used to render the text.*/ setBold(
      bold: boolean,
    ): SlidesApp.TextStyle;
    /**Sets the font family of the text .*/ setFontFamily(
      fontFamily: string,
    ): SlidesApp.TextStyle;
...
non-numerical values disallowed. Weights greater than or equal to 700 are considered bold, in
which case [`isBold()`](https://developers.google.com/apps-script/reference/slides/text-style.html#isBold()) returns `true`. The default value is 400
("normal").*/ setFontFamilyAndWeight(
      fontFamily: string,
      fontWeight: Integer,
    ): SlidesApp.TextStyle;
    /**Sets the font size of the text, in points.*/ setFontSize(
      fontSize: number,
    ): SlidesApp.TextStyle;
    /**Sets the foreground color of the text to the given RGB values from 0 to 255.*/ setForegroundColor(
      red: Integer,
      green: Integer,
      blue: Integer,
    ): SlidesApp.TextStyle;
    /**Sets the foreground color of the text.*/ setForegroundColor(
      foregroundColor: SlidesApp.Color,
    ): SlidesApp.TextStyle;
    /**Sets the foreground color of the text to the given [`ThemeColorType`](https://developers.google.com/apps-script/reference/slides/theme-color-type.html).*/ setForegroundColor(
      color: SlidesApp.ThemeColorType,
    ): SlidesApp.TextStyle;
...
'#FFC0CB'.*/ setForegroundColor(hexColor: string): SlidesApp.TextStyle;
    /**Sets the whether the text is italicized.*/ setItalic(
      italic: boolean,
    ): SlidesApp.TextStyle;
    /**Sets a [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) to the given [`Slide`](https://developers.google.com/apps-script/reference/slides/slide.html) using the zero-based index of the slide.
...
```
@param slideIndex The zero-based index to the slide.*/ setLinkSlide(
      slideIndex: Integer,
    ): SlidesApp.TextStyle;
    /**Sets a [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) to the given [`Slide`](https://developers.google.com/apps-script/reference/slides/slide.html), the link is set by the given slide ID.
...
```
@param slide The [`Slide`](https://developers.google.com/apps-script/reference/slides/slide.html) to be linked.*/ setLinkSlide(
      slide: SlidesApp.Slide,
    ): SlidesApp.TextStyle;
    /**Sets a [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) to the given [`Slide`](https://developers.google.com/apps-script/reference/slides/slide.html) using the relative position of the slide.
...
```
@param slidePosition The relative [`SlidePosition`](https://developers.google.com/apps-script/reference/slides/slide-position.html).*/ setLinkSlide(
      slidePosition: SlidesApp.SlidePosition,
    ): SlidesApp.TextStyle;
    /**Sets a [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) to the given non-empty URL string.
...
@param url The URL string.*/ setLinkUrl(url: string): SlidesApp.TextStyle;
    /**Sets whether the text is rendered in small capital letters.*/ setSmallCaps(
      smallCaps: boolean,
    ): SlidesApp.TextStyle;
    /**Sets whether the text is struck through.*/ setStrikethrough(
      strikethrough: boolean,
    ): SlidesApp.TextStyle;
    /**Sets whether the text is underlined.*/ setUnderline(
      underline: boolean,
    ): SlidesApp.TextStyle;
  }
  interface TextRange {
...
@return the appended [`Paragraph`](https://developers.google.com/apps-script/reference/slides/paragraph.html).*/ appendParagraph(
      text: string,
    ): SlidesApp.Paragraph;
...
@return the text range representing the appended text*/ appendRange(
...
@return the text range representing the appended text.*/ appendText(
      text: string,
    ): SlidesApp.TextRange;
...
@param endOffset The number of characters past the start index of the current text range used
    ...
    equal to the length of the current range.*/ clear(
      startOffset: Integer,
      endOffset: Integer,
    ): void;
...
@param startOffset The number of characters past the start index of the current text range used
    ...
    also be less than the length of the current range.*/ find(
      pattern: string,
      startOffset: Integer,
    ): SlidesApp.TextRange[];
...
@param endOffset The number of characters past the start index of the current text range used
    ...
    equal to or greater than `startOffset`. `endOffset` must also be less than or
    equal to the length of the current range.*/ getRange(
      startOffset: Integer,
      endOffset: Integer,
    ): SlidesApp.TextRange;
...
@return the inserted [`Paragraph`](https://developers.google.com/apps-script/reference/slides/paragraph.html).*/ insertParagraph(
      startOffset: Integer,
      text: string,
    ): SlidesApp.Paragraph;
...
@return the text range representing the inserted text*/ insertRange(
      startOffset: Integer,
      textRange: SlidesApp.TextRange,
    ): SlidesApp.TextRange;
    /**Inserts a copy of the provided text range at the start offset.
...
@param startOffset The number of characters past the start index of the current text range used
    to determine the inclusive start index of the text to insert.
@param text The string to insert.
@return the text range representing the inserted text.*/ insertText(
      startOffset: Integer,
      text: string,
    ): SlidesApp.TextRange;
...
@return the number of occurrences changed*/ replaceAllText(
      findText: string,
      replaceText: string,
    ): Integer;
...
@return the text range representing the set text*/ setText(
      newText: string,
    ): SlidesApp.TextRange;
  }
  ...
  interface _TextDirection {
    ...
    /**A text direction that is not supported.*/ UNSUPPORTED: TextDirection;
  }
  interface TextBaselineOffset {}
  interface _TextBaselineOffset {
    ...
    /**An text baseline offset that is not supported.*/ UNSUPPORTED: TextBaselineOffset;
  }
  interface TableRow {
...
If no rows remain in the table after this removal, the whole table is removed.*/ remove(): void;
  }
  interface TableColumn {
    /**Returns the cell at the specified index.
@param cellIndex The 0-based index of the cell to retrieve.*/ getCell(
      cellIndex: Integer,
    ): SlidesApp.TableCell;
...
If no columns remain in the table after this removal, the whole table is removed.*/ remove(): void;
  }
  interface TableCellRange {
    /**Returns the list of [`TableCell`](https://developers.google.com/apps-script/reference/slides/table-cell.html) instances.*/ getTableCells(): SlidesApp.TableCell[];
  }
  interface TableCell {
...
Text within a table cell always terminates with a newline character.*/ getText(): SlidesApp.TextRange;
    /**Sets the [`ContentAlignment`](https://developers.google.com/apps-script/reference/slides/content-alignment.html) of the text in the table cell.*/ setContentAlignment(
...
@return The table row retrieved.*/ getRow(
      rowIndex: Integer,
    ): SlidesApp.TableRow;
    /**Returns the page element's alt text title. The title is combined with the description to
display and read alt text.
...
@return The new inserted column.*/ insertColumn(
      index: Integer,
    ): SlidesApp.TableColumn;
...
```
@param title The string to set the alt text title to.
@return This page element.*/ setTitle(
      title: string,
    ): SlidesApp.SpeakerSpotlight;
    /**Sets the element's vertical position in points, measured from the upper-left corner of the page
when the element has no rotation.
...
@return This page element, for chaining.*/ setWidth(
  ...
  interface _SpacingMode {
    ...
    /**A spacing mode that is not supported.*/ UNSUPPORTED: SpacingMode;
  }
  interface SolidFill {
    /**Get the opacity of the color, in the interval from [0, 1.0], where 1.0 means fully opaque.*/ getAlpha(): number;
    /**Get the color of the fill.*/ getColor(): SlidesApp.Color;
  }
  interface SlidePosition {}
  interface _SlidePosition {
    ...
    /**The previous slide.*/ PREVIOUS_SLIDE: SlidePosition;
  }
  interface SlideLinkingMode {}
  interface _SlideLinkingMode {
    /**Indicates that slides are linked.*/ LINKED: SlideLinkingMode;
    /**Indicates that slides aren't linked.*/ NOT_LINKED: SlideLinkingMode;
    /**A slide linking mode that isn't supported.*/ UNSUPPORTED: SlideLinkingMode;
  }
  interface Slide {
...
@return The page element with the given ID.*/ getPageElementById(
      id: string,
...
@return The inserted group.*/ insertGroup(
...
@return The inserted line.*/ insertLine(
...
@return The inserted page element.*/ insertPageElement(
...
@return The inserted shape.*/ insertShape(
...
@return The inserted sheets chart.*/ insertSheetsChart(
...
@return The inserted chart in the page.*/ insertSheetsChart(
...
```
@param sourceChart The chart in a spreadsheet to be inserted in the page.
@return The inserted image of the chart in the page.*/ insertSheetsChartAsImage(
      sourceChart: SpreadsheetApp.EmbeddedChart,
    ): SlidesApp.Image;
...
@return The inserted text box shape.*/ insertTextBox(
      text: string,
    ): SlidesApp.Shape;
    /**Inserts a text box [`Shape`](https://developers.google.com/apps-script/reference/slides/shape.html) containing the provided string on the page.
...
@return The inserted video.*/ insertVideo(
...
@return The inserted word art.*/ insertWordArt(
...
@param isSkipped `True` to skip the slide in the presentation mode.*/ setSkipped(
      isSkipped: boolean,
    ): void;
...
```*/ unlink(): void;
  ...
  interface SheetsChartEmbedType {}
  interface _SheetsChartEmbedType {
    /**Indicates that the chart is embedded as an image.*/ IMAGE: SheetsChartEmbedType;
    /**Represents a chart that is not supported and cannot be further classified.*/ UNSUPPORTED: SheetsChartEmbedType;
  }
...
'wedgeRoundRectCallout'.*/ WEDGE_ROUND_RECTANGLE_CALLOUT: ShapeType;
  }
  interface Shape {
    /**Aligns the element to the specified alignment position on the page.
@param alignmentPosition The position to align this page element to on the page.
...
```
@param blobSource The image data.
@return The [`Image`](https://developers.google.com/apps-script/reference/slides/image.html) that replaced the shape.*/ replaceWithImage(
      blobSource: BlobSource,
    ): SlidesApp.Image;
    /**Replaces this shape with an image provided by a [`BlobSource`](https://developers.google.com/apps-script/reference/slides/../base/blob-source.html).
...
@return The chart that replaced the shape.*/ replaceWithSheetsChart(
      sourceChart: SpreadsheetApp.EmbeddedChart,
    ): SlidesApp.SheetsChart;
...
```
@param sourceChart The chart in a spreadsheet that replaces the shape.
@return The image of the chart that replaced the shape.*/ replaceWithSheetsChartAsImage(
      sourceChart: SpreadsheetApp.EmbeddedChart,
    ): SlidesApp.Image;
    /**Scales the element's height by the specified ratio. The element's height is the height of its
bounding box when the element has no rotation.
...
@return This shape, for chaining.*/ setContentAlignment(
      contentAlignment: SlidesApp.ContentAlignment,
    ): SlidesApp.Shape;
    /**Sets the page element's alt text description.
...
@return This page element, for chaining.*/ setWidth(
  ...
  interface _SelectionType {
    ...
    /**A selection type that is not supported.*/ UNSUPPORTED: SelectionType;
  }
  interface Selection {
...
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html), for chaining.*/ addEditor(
      emailAddress: string,
    ): SlidesApp.Presentation;
    /**Adds the given user to the list of editors for the [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html). If the user was already
on the list of viewers, this method promotes the user out of the list of viewers.
...
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html), for chaining.*/ addEditors(
...
@param emailAddress The email address of the user to add.
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html), for chaining.*/ addViewer(
      emailAddress: string,
    ): SlidesApp.Presentation;
    /**Adds the given user to the list of viewers for the [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html). If the user was already
on the list of editors, this method has no effect.
...
@param emailAddresses An array of email addresses of the users to add.
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html), for chaining.*/ addViewers(
      emailAddresses: string[],
    ): SlidesApp.Presentation;
...
@return The new slide that is appended.*/ appendSlide(
...
@return The new slide.*/ appendSlide(
      slide: SlidesApp.Slide,
...
@return The slide with the given ID.*/ getSlideById(
      id: string,
    ): SlidesApp.Slide;
...
@return The new slide that is inserted.*/ insertSlide(
...
@param slide The slide to be copied and inserted.
@param linkingMode The link mode to use.
@return The new slide.*/ insertSlide(
      insertionIndex: Integer,
      slide: SlidesApp.Slide,
      linkingMode: SlidesApp.SlideLinkingMode,
    ): SlidesApp.Slide;
...
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html), for chaining.*/ removeEditor(
      emailAddress: string,
    ): SlidesApp.Presentation;
    /**Removes the given user from the list of editors for the [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html). This method doesn't
block users from accessing the [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html) if they belong to a class of users who have
...
@param emailAddress The email address of the user to remove.
@return This [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html) for chaining.*/ removeViewer(
      emailAddress: string,
    ): SlidesApp.Presentation;
    /**Removes the given user from the list of viewers and commenters for the [`Presentation`](https://developers.google.com/apps-script/reference/slides/presentation.html). This
...
@param name The name to set for this presentation.*/ setName(
      name: string,
    ): void;
  }
  interface PredefinedLayout {}
  interface _PredefinedLayout {
    ...
    /**A layout that is not supported.*/ UNSUPPORTED: PredefinedLayout;
  }
  interface Point {
    /**Gets the horizontal coordinate, measured in points.*/ getX(): number;
    /**Gets the vertical coordinate, measured in points.*/ getY(): number;
  }
  interface PlaceholderType {}
  interface _PlaceholderType {
    ...
    /**A placeholder type that is not supported.*/ UNSUPPORTED: PlaceholderType;
  }
...
The side that corresponds to the end of the text is based on the current text direction.*/ setIndentEnd(
      indent: number,
    ): SlidesApp.ParagraphStyle;
    /**Sets the indentation for the first line of paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html) in points.*/ setIndentFirstLine(
      indent: number,
    ): SlidesApp.ParagraphStyle;
...
The side that corresponds to the start of the text is based on the current text direction.*/ setIndentStart(
      indent: number,
    ): SlidesApp.ParagraphStyle;
    /**Sets the line spacing.

This is a value that corresponds to the space between lines, as a percentage of normal.
Normal is represented as 100.0.*/ setLineSpacing(
      spacing: number,
    ): SlidesApp.ParagraphStyle;
    /**Sets the [`ParagraphAlignment`](https://developers.google.com/apps-script/reference/slides/paragraph-alignment.html) of paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html).*/ setParagraphAlignment(
      alignment: SlidesApp.ParagraphAlignment,
    ): SlidesApp.ParagraphStyle;
    /**Sets the extra space above paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html) in points.*/ setSpaceAbove(
      space: number,
    ): SlidesApp.ParagraphStyle;
    /**Sets the extra space below paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html) in points.*/ setSpaceBelow(
      space: number,
    ): SlidesApp.ParagraphStyle;
    /**Sets the [`SpacingMode`](https://developers.google.com/apps-script/reference/slides/spacing-mode.html) for paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html).*/ setSpacingMode(
      mode: SlidesApp.SpacingMode,
    ): SlidesApp.ParagraphStyle;
    /**Sets the [`TextDirection`](https://developers.google.com/apps-script/reference/slides/text-direction.html) for paragraphs in the [`TextRange`](https://developers.google.com/apps-script/reference/slides/text-range.html).*/ setTextDirection(
      direction: SlidesApp.TextDirection,
    ): SlidesApp.ParagraphStyle;
  }
  interface ParagraphAlignment {}
  interface _ParagraphAlignment {
...
right-aligned otherwise.*/ START: ParagraphAlignment;
    /**A paragraph alignment that is not supported.*/ UNSUPPORTED: ParagraphAlignment;
  }
  interface Paragraph {
...
character. Returns `null` if the paragraph's newline has been deleted.*/ getRange(): SlidesApp.TextRange;
  }
  interface PageType {}
  interface _PageType {
    ...
    /**A page type that is not supported.*/ UNSUPPORTED: PageType;
  }
  interface PageRange {
    /**Returns the list of [`Page`](https://developers.google.com/apps-script/reference/slides/page.html) instances.*/ getPages(): SlidesApp.Page[];
  }
  interface PageElementType {}
  interface _PageElementType {
    ...
    /**Represents word art.*/ WORD_ART: PageElementType;
  }
  interface PageElementRange {
    /**Returns the list of [`PageElement`](https://developers.google.com/apps-script/reference/slides/page-element.html) instances.*/ getPageElements(): SlidesApp.PageElement[];
  }
...
@return This page element, for chaining.*/ setWidth(
  ...
  interface PageBackgroundType {}
  interface _PageBackgroundType {
    ...
    /**A page background type that is not supported.*/ UNSUPPORTED: PageBackgroundType;
  }
...
display inside the presentation. Images must be less than 50MB in size, cannot exceed 25
megapixels, and must be in either in PNG, JPEG, or GIF format.
@param blobSource The image data.*/ setPictureFill(
      blobSource: BlobSource,
    ): void;
...
@param imageUrl The URL to download the image from.*/ setPictureFill(
      imageUrl: string,
    ): void;
    /**Sets the solid fill to the given RGB values.*/ setSolidFill(
      red: Integer,
      green: Integer,
      blue: Integer,
    ): void;
    /**Sets the solid fill to the given alpha and RGB values.*/ setSolidFill(
      red: Integer,
      green: Integer,
      blue: Integer,
      alpha: number,
    ): void;
    /**Sets the solid fill to the given [`Color`](https://developers.google.com/apps-script/reference/slides/color.html).*/ setSolidFill(
      color: SlidesApp.Color,
    ): void;
    /**Sets the solid fill to the given alpha and [`Color`](https://developers.google.com/apps-script/reference/slides/color.html).*/ setSolidFill(
      color: SlidesApp.Color,
      alpha: number,
    ): void;
    /**Sets the solid fill to the given [`ThemeColorType`](https://developers.google.com/apps-script/reference/slides/theme-color-type.html).*/ setSolidFill(
      color: SlidesApp.ThemeColorType,
    ): void;
    /**Sets the solid fill to the given alpha and [`ThemeColorType`](https://developers.google.com/apps-script/reference/slides/theme-color-type.html).*/ setSolidFill(
      color: SlidesApp.ThemeColorType,
      alpha: number,
    ): void;
...
'#FFC0CB'.*/ setSolidFill(hexString: string, alpha: number): void;
    /**Sets the background to transparent.*/ setTransparent(): void;
  }
  interface Page {
...
paragraphs being updated are added to that preceding list.*/ applyListPreset(
...
the corresponding paragraph.*/ removeFromList(): SlidesApp.ListStyle;
  }
  interface ListPreset {}
  interface _ListPreset {
...
followed by periods.*/ ZERODIGIT_ALPHA_ROMAN: ListPreset;
  }
  interface List {
    /**Returns the ID of the list.*/ getListId(): string;
    /**Returns all the [`Paragraphs`](https://developers.google.com/apps-script/reference/slides/paragraph.html) in the list.*/ getListParagraphs(): SlidesApp.Paragraph[];
  }
  interface LinkType {}
  interface _LinkType {
    ...
    /**A link to an external web page.*/ URL: LinkType;
  }
  interface Link {
...
```*/ getUrl(): string;
  ...
  interface _LineType {
    ...
    /**A line type that is not supported.*/ UNSUPPORTED: LineType;
  }
  interface LineFillType {}
  interface _LineFillType {
    /**No fill, so the line or outline is transparent.*/ NONE: LineFillType;
    /**A solid color fill.*/ SOLID: LineFillType;
    /**A line fill type that is not supported.*/ UNSUPPORTED: LineFillType;
  }
  interface LineFill {
...
'#FFC0CB'.*/ setSolidFill(hexString: string, alpha: number): void;
  ...
  interface _LineCategory {
    ...
    /**A line category that is not supported.*/ UNSUPPORTED: LineCategory;
  }
  interface Line {
    /**Aligns the element to the specified alignment position on the page.
@param alignmentPosition The position to align this page element to on the page.
...
@return This line, for chaining.*/ setDashStyle(
...
@param top The vertical position of the end point of the line, measured in points from the
    upper left corner of the page.
@return This line, for chaining.*/ setEnd(
      left: number,
      top: number,
    ): SlidesApp.Line;
    /**Sets the position of the end point of the line.
...
@return This line, for chaining.*/ setEndArrow(
...
@return The line.*/ setEndConnection(
...
@return The line.*/ setLineCategory(
      lineCategory: SlidesApp.LineCategory,
    ): SlidesApp.Line;
    /**Sets a [`Link`](https://developers.google.com/apps-script/reference/slides/link.html) to the given [`Slide`](https://developers.google.com/apps-script/reference/slides/slide.html) using the zero-based index of the slide.
...
@param top The vertical position of the start point of the line, measured in points from the
    upper left corner of the page.
@return This line, for chaining.*/ setStart(
      left: number,
      top: number,
    ): SlidesApp.Line;
    /**Sets the position of the start point of the line.
...
@return This line, for chaining.*/ setStartArrow(
      style: SlidesApp.ArrowStyle,
    ): SlidesApp.Line;
...
@return The line.*/ setStartConnection(
      connectionSite: SlidesApp.ConnectionSite,
    ): SlidesApp.Line;
    /**Sets the page element's alt text title.
...
```
@param blobSource The image data.
@return This `Image` after the replacement.*/ replace(
      blobSource: BlobSource,
    ): SlidesApp.Image;
...
Groups inside other groups cannot be ungrouped.*/ ungroup(): void;
  }
  interface FillType {}
  interface _FillType {
    /**No fill, so the background is transparent.*/ NONE: FillType;
    /**A solid color fill.*/ SOLID: FillType;
    /**A fill type that is not supported.*/ UNSUPPORTED: FillType;
  }
  interface Fill {
...
dash style.*/ SOLID: DashStyle;
    /**A dash style that is not supported.*/ UNSUPPORTED: DashStyle;
  }
  interface ContentAlignment {}
  interface _ContentAlignment {
...
ST_TextAnchoringType 't'.*/ TOP: ContentAlignment;
    /**A content alignment that is not supported.*/ UNSUPPORTED: ContentAlignment;
  }
...
@return The page element of the connection site.*/ getPageElement(): SlidesApp.PageElement;
  }
...
@return The concrete color corresponding the theme color type in this scheme.*/ getConcreteColor(
...
@return This color scheme, for chaining.*/ setConcreteColor(
...
@return The color type.*/ getColorType(): ColorType;
  ...
  interface CellMergeState {}
  interface _CellMergeState {
...
```*/ MERGED: CellMergeState;
    /**The cell is not merged.*/ NORMAL: CellMergeState;
  }
  interface Border {
...
Setting a [`DashStyle`](https://developers.google.com/apps-script/reference/slides/dash-style.html) on a transparent border makes it visible.*/ setDashStyle(
      style: SlidesApp.DashStyle,
    ): SlidesApp.Border;
    /**Sets the border to be transparent.*/ setTransparent(): SlidesApp.Border;
    /**Sets the thickness of the border in points.

Setting a weight on a transparent border makes it visible.*/ setWeight(
      points: number,
    ): SlidesApp.Border;
  }
  interface AutofitType {}
  interface _AutofitType {
    ...
    /**An autofit type that is not supported.*/ UNSUPPORTED: AutofitType;
  }
  interface Autofit {
...
@return The line spacing.*/ getLineSpacingReduction(): number;
  }
  interface AutoTextType {}
  interface _AutoTextType {
    /**A slide number.*/ SLIDE_NUMBER: AutoTextType;
    /**An auto text type that is not supported.*/ UNSUPPORTED: AutoTextType;
  }
  interface AutoText {
...
been deleted.*/ getRange(): SlidesApp.TextRange;
  }
  interface ArrowStyle {}
  interface _ArrowStyle {
    ...
    /**An arrow style that is not supported.*/ UNSUPPORTED: ArrowStyle;
  }
  interface AlignmentPosition {}
  interface _AlignmentPosition {
    /**Align to the center.*/ CENTER: AlignmentPosition;
    /**Align to the horizontal center.*/ HORIZONTAL_CENTER: AlignmentPosition;
    /**Align to the vertical center.*/ VERTICAL_CENTER: AlignmentPosition;
  }
  interface AffineTransformBuilder {
    ...
    /**Sets the X coordinate scaling element and returns the builder.*/ setScaleX(
      scaleX: number,
    ): SlidesApp.AffineTransformBuilder;
    /**Sets the Y coordinate scaling element and returns the builder.*/ setScaleY(
      scaleY: number,
    ): SlidesApp.AffineTransformBuilder;
    /**Sets the X coordinate shearing element and returns the builder.*/ setShearX(
      shearX: number,
    ): SlidesApp.AffineTransformBuilder;
    /**Sets the Y coordinate shearing element and returns the builder.*/ setShearY(
      shearY: number,
    ): SlidesApp.AffineTransformBuilder;
    /**Sets the X coordinate translation element in points, and returns the builder.*/ setTranslateX(
      translateX: number,
    ): SlidesApp.AffineTransformBuilder;
    /**Sets the Y coordinate translation element in points, and returns the builder.*/ setTranslateY(
      translateY: number,
    ): SlidesApp.AffineTransformBuilder;
  }
  interface AffineTransform {
    ...
    /**Returns a new [`AffineTransformBuilder`](https://developers.google.com/apps-script/reference/slides/affine-transform-builder.html) based on this transform.*/ toBuilder(): SlidesApp.AffineTransformBuilder;
  }
}
