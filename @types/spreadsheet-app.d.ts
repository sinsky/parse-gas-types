...
@return a new spreadsheet*/ create(
    name: string,
    rows: Integer,
    columns: Integer,
...
@return the Spreadsheet object with the given id*/ openById(
    id: string,
  ): SpreadsheetApp.Spreadsheet;
...
@return The spreadsheet object with the given URL.*/ openByUrl(
    url: string,
  ): SpreadsheetApp.Spreadsheet;
...
@return the new active Range*/ setActiveRange(
...
@return the newly selected list of ranges*/ setActiveRangeList(
...
@return the sheet that has been made the new active sheet*/ setActiveSheet(
...
@return the new active sheet*/ setActiveSheet(
    sheet: SpreadsheetApp.Sheet,
...
```
@param newActiveSpreadsheet The Spreadsheet to be made the active spreadsheet.*/ setActiveSpreadsheet(
...
@return the newly set current cell*/ setCurrentCell(
    cell: SpreadsheetApp.Range,
  ): SpreadsheetApp.Range;
}
module SpreadsheetApp {
  interface WrapStrategy {}
  interface _WrapStrategy {
...
than a line are wrapped at the character level.*/ WRAP: WrapStrategy;
  }
  interface ValueType {}
  interface _ValueType {
    /**The value type when the cell contains an image.*/ IMAGE: ValueType;
  }
  interface ThemeColorType {}
  interface _ThemeColorType {
    ...
    /**Represents a theme color that is not supported.*/ UNSUPPORTED: ThemeColorType;
  }
  interface ThemeColor {
    /**Get the type of this color.
@return The color type.*/ getColorType(): ColorType;
    /**Gets the theme color type of this color.
@return The theme color type.*/ getThemeColorType(): SpreadsheetApp.ThemeColorType;
  }
  interface TextToColumnsDelimiter {}
  interface _TextToColumnsDelimiter {
    /**`","` delimiter.*/ COMMA: TextToColumnsDelimiter;
    /**`"."` delimiter.*/ PERIOD: TextToColumnsDelimiter;
    /**`";"` delimiter.*/ SEMICOLON: TextToColumnsDelimiter;
    /**`" "` delimiter.*/ SPACE: TextToColumnsDelimiter;
  }
...
settings.
@return Whether or not the cell is underlined, or `null`.*/ isUnderline(): boolean;
  }
...
@return Whether or not the text is stacked vertically.*/ isVertical(): boolean;
  }
...
@return This text finder, for chaining.*/ ignoreDiacritics(
...
@return This text finder, for chaining.*/ matchCase(
      matchCase: boolean,
    ): SpreadsheetApp.TextFinder;
...
@return This text finder, for chaining.*/ matchEntireCell(
...
@return This text finder, for chaining.*/ matchFormulaText(
...
@return The number of occurrences replaced.*/ replaceAllWith(
      replaceText: string,
    ): Integer;
...
@return The number of occurrences replaced.*/ replaceWith(
      replaceText: string,
    ): Integer;
...
@return This text finder, for chaining.*/ startFrom(
...
@return This text finder, for chaining.*/ useRegularExpression(
      useRegEx: boolean,
    ): SpreadsheetApp.TextFinder;
  }
  interface TextDirection {}
  interface _TextDirection {
    /**Left-to-right text direction.*/ LEFT_TO_RIGHT: TextDirection;
    /**Right-to-left text direction.*/ RIGHT_TO_LEFT: TextDirection;
  }
...
@return Concrete color.*/ getConcreteColor(
...
@return The theme, for chaining.*/ setConcreteColor(
      themeColorType: SpreadsheetApp.ThemeColorType,
      red: Integer,
      green: Integer,
      blue: Integer,
...
@return This theme, for chaining.*/ setFontFamily(
      fontFamily: string,
    ): SpreadsheetApp.SpreadsheetTheme;
  }
...
@return This spreadsheet, for chaining.*/ addDeveloperMetadata(
      key: string,
    ): SpreadsheetApp.Spreadsheet;
...
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html), for chaining.*/ addEditor(
      emailAddress: string,
    ): SpreadsheetApp.Spreadsheet;
    /**Adds the given user to the list of editors for the [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html). If the user was already
on the list of viewers, this method promotes the user out of the list of viewers.
...
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html), for chaining.*/ addEditors(
...
@param emailAddress The email address of the user to add.
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html), for chaining.*/ addViewer(
      emailAddress: string,
    ): SpreadsheetApp.Spreadsheet;
    /**Adds the given user to the list of viewers for the [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html). If the user was already
on the list of editors, this method has no effect.
...
@param emailAddresses An array of email addresses of the users to add.
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html), for chaining.*/ addViewers(
      emailAddresses: string[],
    ): SpreadsheetApp.Spreadsheet;
...
@return The sheet, useful for method chaining.*/ appendRow(
      rowContents: Object[],
    ): SpreadsheetApp.Sheet;
...
@return the sheet, useful for method chaining*/ autoResizeColumn(
...
@return This spreadsheet, for chaining.*/ copy(
      name: string,
    ): SpreadsheetApp.Spreadsheet;
...
@return The [`TextFinder`](https://developers.google.com/apps-script/reference/spreadsheet/text-finder.html) for the spreadsheet.*/ createTextFinder(
      findText: string,
    ): SpreadsheetApp.TextFinder;
...
@return the sheet, useful for method chaining*/ deleteColumn(
      columnPosition: Integer,
    ): SpreadsheetApp.Sheet;
...
@param howMany The number of columns to delete.*/ deleteColumns(
      columnPosition: Integer,
      howMany: Integer,
    ): void;
...
@return the sheet, useful for method chaining*/ deleteRow(
      rowPosition: Integer,
    ): SpreadsheetApp.Sheet;
...
@param howMany The number of rows to delete.*/ deleteRows(
      rowPosition: Integer,
      howMany: Integer,
    ): void;
...
```
@param sheet The sheet to delete.*/ deleteSheet(
      sheet: SpreadsheetApp.Sheet,
    ): void;
...
@return column width in pixels*/ getColumnWidth(
      columnPosition: Integer,
    ): Integer;
...
@return An array of objects representing all protected ranges or sheets in the spreadsheet.*/ getProtections(
...
@return the range at the location designated*/ getRange(
      a1Notation: string,
    ): SpreadsheetApp.Range;
...
@return The range of cells with the given name.*/ getRangeByName(
      name: string,
    ): SpreadsheetApp.Range;
...
@return the range list at the location designated*/ getRangeList(
      a1Notations: string[],
    ): SpreadsheetApp.RangeList;
...
@return The sheet with the given name.*/ getSheetByName(
      name: string,
    ): SpreadsheetApp.Sheet;
...
@return a two-dimensional array of values*/ getSheetValues(
      startRow: Integer,
      startColumn: Integer,
      numRows: Integer,
      numColumns: Integer,
...
sheet.hideColumn(range);
```
@param column The column range to hide.*/ hideColumn(
...
@return the sheet, useful for method chaining*/ insertColumnAfter(
...
@return the sheet, useful for method chaining*/ insertColumnBefore(
...
@return the sheet, useful for method chaining*/ insertColumnsAfter(
      afterPosition: Integer,
      howMany: Integer,
    ): SpreadsheetApp.Sheet;
...
@param beforePosition The column before which the new column should be added.
@param howMany The number of columns to insert.
@return the sheet, useful for method chaining*/ insertColumnsBefore(
      beforePosition: Integer,
      howMany: Integer,
    ): SpreadsheetApp.Sheet;
...
@return The new data source sheet.*/ insertDataSourceSheet(
...
@return The inserted image.*/ insertImage(
...
@return the sheet, useful for method chaining*/ insertRowAfter(
      afterPosition: Integer,
    ): SpreadsheetApp.Sheet;
...
@return the sheet, useful for method chaining*/ insertRowBefore(
      beforePosition: Integer,
    ): SpreadsheetApp.Sheet;
...
@return the sheet, useful for method chaining*/ insertRowsAfter(
      afterPosition: Integer,
      howMany: Integer,
    ): SpreadsheetApp.Sheet;
...
@param howMany The number of rows to insert.
@return the sheet, useful for method chaining*/ insertRowsBefore(
      beforePosition: Integer,
      howMany: Integer,
    ): SpreadsheetApp.Sheet;
...
@return The new sheet.*/ insertSheet(
      sheetIndex: Integer,
      options: Object,
    ): SpreadsheetApp.Sheet;
...
```
@param spec The data source specification to insert with.
@return The new sheet.*/ insertSheetWithDataSourceTable(
      spec: SpreadsheetApp.DataSourceSpec,
    ): SpreadsheetApp.Sheet;
...
```
@param columnPosition The position of the column to examine.
@return `true` if the column is hidden, `false` otherwise.*/ isColumnHiddenByUser(
      columnPosition: Integer,
    ): boolean;
...
```
@param rowPosition The position of the row to examine.
@return `true` if the row is hidden, `false` otherwise.*/ isRowHiddenByFilter(
      rowPosition: Integer,
    ): boolean;
...
```
@param rowPosition The position of the row to examine.
@return `true` if the row is hidden, `false` otherwise.*/ isRowHiddenByUser(
      rowPosition: Integer,
    ): boolean;
...
```
@param pos The 1-index position to move the active sheet to in the list of sheets.*/ moveActiveSheet(
      pos: Integer,
    ): void;
...
@return The sheet that the chart is on.*/ moveChartToObjectSheet(
...
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html), for chaining.*/ removeEditor(
      emailAddress: string,
    ): SpreadsheetApp.Spreadsheet;
    /**Removes the given user from the list of editors for the [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html). This method doesn't
block users from accessing the [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html) if they belong to a class of users who have
...
@param emailAddress The email address of the user to remove.
@return This [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html) for chaining.*/ removeViewer(
      emailAddress: string,
    ): SpreadsheetApp.Spreadsheet;
    /**Removes the given user from the list of viewers and commenters for the [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html). This
...
```
@param newName The new name for the current active sheet.*/ renameActiveSheet(
      newName: string,
    ): void;
...
@return the newly active range*/ setActiveRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.Range;
...
@return the newly active range*/ setActiveSelection(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.Range;
...
@return The active sheet.*/ setActiveSheet(
      sheet: SpreadsheetApp.Sheet,
    ): SpreadsheetApp.Sheet;
...
@param anonymousWriteAllowed `true` to allow anonymous reads; `false` otherwise.*/ setAnonymousAccess(
...
@return the sheet, useful for method chaining*/ setColumnWidth(
      columnPosition: Integer,
      width: Integer,
    ): SpreadsheetApp.Sheet;
...
```
@param columns The number of columns to freeze.*/ setFrozenColumns(
      columns: Integer,
    ): void;
...
@return This spreadsheet, for chaining.*/ setIterativeCalculationConvergenceThreshold(
      minThreshold: number,
    ): SpreadsheetApp.Spreadsheet;
...
@param isEnabled `true` if iterative calculation should be enabled; `false`
    otherwise.
@return This spreadsheet, for chaining.*/ setIterativeCalculationEnabled(
      isEnabled: boolean,
    ): SpreadsheetApp.Spreadsheet;
...
@return This spreadsheet, for chaining.*/ setMaxIterativeCalculationCycles(
...
@param range The range specification.*/ setNamedRange(
      name: string,
      range: SpreadsheetApp.Range,
    ): void;
...
@return This spreadsheet, for chaining.*/ setRecalculationInterval(
...
@return The sheet, useful for method chaining.*/ setRowHeight(
      rowPosition: Integer,
      height: Integer,
    ): SpreadsheetApp.Sheet;
...
```
@deprecated
@param permissions The access permissions object to set on this sheet.*/ setSheetProtection(
...
console.log(ssLocale);
```
@param locale The locale code to use (for example, 'en', 'fr', or 'en_US').*/ setSpreadsheetLocale(
      locale: string,
    ): void;
...
@return The new current theme.*/ setSpreadsheetTheme(
...
@param timezone The time zone, specified in "long" format (for example, "America/New_York", as
    listed by [Joda.org](http://joda-time.sourceforge.net/timezones.html)).*/ setSpreadsheetTimeZone(
      timezone: string,
    ): void;
...
```
@param userInterface An [`HtmlOutput`](https://developers.google.com/apps-script/reference/spreadsheet/../html/html-output.html).*/ show(
...
@return the sheet, useful for method chaining*/ sort(
      columnPosition: Integer,
    ): SpreadsheetApp.Sheet;
...
@param title The optional title of the toast.*/ toast(
      msg: string,
      title: string,
    ): void;
...
@param timeoutSeconds The timeout in seconds; if `null`, the toast defaults to 5 seconds;
    if negative, the toast remains until dismissed.*/ toast(
      msg: string,
      title: string,
...
```
@param column The range to unhide, if hidden.*/ unhideColumn(
      column: SpreadsheetApp.Range,
    ): void;
...
```
@param row The range to unhide, if hidden.*/ unhideRow(
...
@param timeoutInSeconds The time to wait for data executions, in seconds. The maximum is 300
    seconds.*/ waitForAllDataExecutionsCompletion(
...
@return `true` if the sort order is ascending, or `false` otherwise.*/ isAscending(): boolean;
  }
  interface SortOrder {}
  interface _SortOrder {
    /**Ascending sort order.*/ ASCENDING: SortOrder;
    /**Descending sort order.*/ DESCENDING: SortOrder;
  }
  interface Slicer {
...
@return This slicer, for chaining.*/ setApplyToPivotTables(
...
@return This slicer, for chaining.*/ setBackgroundColor(
      color: string,
    ): SpreadsheetApp.Slicer;
...
@return This slicer, for chaining.*/ setBackgroundColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Slicer;
...
@return This slicer, for chaining.*/ setColumnFilterCriteria(
      columnPosition: Integer,
...
@param offsetX The horizontal offset from cell corner in pixels.
@param offsetY The vertical offset from cell corner in pixels.
@return This slicer, for chaining.*/ setPosition(
...
@return This slicer, for chaining.*/ setRange(
...
@return This slicer, for chaining.*/ setTitle(
      title: string,
    ): SpreadsheetApp.Slicer;
...
@return This slicer, for chaining.*/ setTitleHorizontalAlignment(
      horizontalAlignment: string,
    ): SpreadsheetApp.Slicer;
    /**Sets the text style of the slicer.
@param textStyle The new text style of the slicer's title.
@return This slicer, for chaining.*/ setTitleTextStyle(
      textStyle: SpreadsheetApp.TextStyle,
    ): SpreadsheetApp.Slicer;
  }
  interface SheetType {}
  interface _SheetType {
    ...
    /**A sheet containing a single embedded object such as an [`EmbeddedChart`](https://developers.google.com/apps-script/reference/spreadsheet/embedded-chart.html).*/ OBJECT: SheetType;
  }
  interface Sheet {
...
```
@param key The key for the new developer metadata.
@return This sheet, for chaining.*/ addDeveloperMetadata(
      key: string,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ autoResizeColumns(
      startColumn: Integer,
      numColumns: Integer,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ autoResizeRows(
      startRow: Integer,
      numRows: Integer,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ clear(
      options: Object,
    ): SpreadsheetApp.Sheet;
...
@param spreadsheet The spreadsheet to copy this sheet to, which can be the same spreadsheet as
    the source.
@return The new sheet, for chaining.*/ copyTo(
...
```
@param findText The text to search for.
@return The [`TextFinder`](https://developers.google.com/apps-script/reference/spreadsheet/text-finder.html) for the sheet.*/ createTextFinder(
      findText: string,
    ): SpreadsheetApp.TextFinder;
    /**Deletes the column at the given column position.
...
@return This sheet, for chaining.*/ expandColumnGroupsUpToDepth(
      groupDepth: Integer,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ expandRowGroupsUpToDepth(
      groupDepth: Integer,
    ): SpreadsheetApp.Sheet;
    /**Returns the active cell in this sheet.
...
@return The group depth of the column at the given index.*/ getColumnGroupDepth(
      columnIndex: Integer,
    ): Integer;
    /**Gets the width in pixels of the given column.
...
@return An array of objects representing all protected ranges in the sheet, or a single-element
    array representing the protection on the sheet itself.*/ getProtections(
      type: SpreadsheetApp.ProtectionType,
    ): SpreadsheetApp.Protection[];
...
@return A range containing only this cell.*/ getRange(
      row: Integer,
      column: Integer,
    ): SpreadsheetApp.Range;
...
@return A range containing a single column of data with the number of rows specified.*/ getRange(
      row: Integer,
      column: Integer,
      numRows: Integer,
    ): SpreadsheetApp.Range;
...
@return A range corresponding to the area specified.*/ getRange(
      row: Integer,
      column: Integer,
      numRows: Integer,
      numColumns: Integer,
...
@return The group depth of the row at the given index.*/ getRowGroupDepth(
      rowIndex: Integer,
    ): Integer;
    /**Gets the height in pixels of the given row.
...
sheet.hideColumns(1);
```
@param columnIndex The index of the column to hide.*/ hideColumns(
      columnIndex: Integer,
    ): void;
...
@param numColumns The number of columns to hide.*/ hideColumns(
      columnIndex: Integer,
      numColumns: Integer,
    ): void;
    /**Hides the rows in the given range.
...
sheet.hideRows(1);
```
@param rowIndex The index of the row to hide.*/ hideRows(
      rowIndex: Integer,
    ): void;
...
@param numRows The number of rows to hide.*/ hideRows(
      rowIndex: Integer,
      numRows: Integer,
    ): void;
...
sheet.insertChart(chart);
```
@param chart The chart to insert.*/ insertChart(
      chart: SpreadsheetApp.EmbeddedChart,
    ): void;
    /**Inserts a column after the given column position.
...
```
@param columnIndex The index indicating where to insert a column.*/ insertColumns(
      columnIndex: Integer,
    ): void;
...
@param numColumns The number of columns to insert.*/ insertColumns(
      columnIndex: Integer,
      numColumns: Integer,
    ): void;
    /**Inserts a given number of columns after the given column position.
...
sheet.insertRows(1);
```
@param rowIndex The index indicating where to insert a row.*/ insertRows(
      rowIndex: Integer,
    ): void;
...
@param numRows The number of rows to insert.*/ insertRows(
      rowIndex: Integer,
      numRows: Integer,
    ): void;
    /**Inserts a number of rows after the given row position.
...
@param anchorRowPos The slicer's top side is anchored in this row.
@param anchorColPos The slicer's top side is anchored in this col.
@return The newly inserted slicer.*/ insertSlicer(
      range: SpreadsheetApp.Range,
      anchorRowPos: Integer,
      anchorColPos: Integer,
    ): SpreadsheetApp.Slicer;
...
@param destinationIndex The index that the columns should be moved to. Note that this index is
    ...
    Therefore, the data may end up at a different index than originally specified.*/ moveColumns(
...
@param destinationIndex The index that the rows should be moved to. Note that this index is
    ...
    data may end up at a different index than originally specified.*/ moveRows(
...
```
@param chart The chart to remove.*/ removeChart(
      chart: SpreadsheetApp.EmbeddedChart,
    ): void;
...
@return This sheet, for chaining.*/ setColumnGroupControlPosition(
...
@param width The width in pixels to set it to.
@return This sheet, for chaining.*/ setColumnWidths(
      startColumn: Integer,
      numColumns: Integer,
      width: Integer,
    ): SpreadsheetApp.Sheet;
...
sheet.setConditionalFormatRules(rules);
```
@param rules The new conditional format rules.*/ setConditionalFormatRules(
...
@param hideGridlines If `true`, hide gridlines in this sheet; otherwise show the
    gridlines.
@return This sheet, for chaining.*/ setHiddenGridlines(
...
@return This sheet, for chaining.*/ setRightToLeft(
      rightToLeft: boolean,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ setRowGroupControlPosition(
      position: SpreadsheetApp.GroupControlTogglePosition,
    ): SpreadsheetApp.Sheet;
    /**Sets the row height of the given row in pixels. By default, rows grow to fit cell contents. If
...
@param height The height in pixels to set it to.
@return This sheet, for chaining.*/ setRowHeights(
      startRow: Integer,
      numRows: Integer,
      height: Integer,
    ): SpreadsheetApp.Sheet;
...
@param numRows The number of rows to change.
@param height The height in pixels to set it to.
@return This sheet, for chaining.*/ setRowHeightsForced(
      startRow: Integer,
      numRows: Integer,
      height: Integer,
    ): SpreadsheetApp.Sheet;
...
@return This sheet, for chaining.*/ setTabColor(
      color: string,
    ): SpreadsheetApp.Sheet;
    /**Sets the sheet tab color.
...
@return This sheet, for chaining.*/ setTabColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Sheet;
...
sheet.showColumns(1);
```
@param columnIndex The index of the column to unhide.*/ showColumns(
      columnIndex: Integer,
    ): void;
...
@param numColumns The number of columns to unhide.*/ showColumns(
      columnIndex: Integer,
      numColumns: Integer,
    ): void;
...
sheet.showRows(1);
```
@param rowIndex The index of the row to unhide.*/ showRows(
      rowIndex: Integer,
    ): void;
...
@param numRows The number of rows to unhide.*/ showRows(
      rowIndex: Integer,
      numRows: Integer,
    ): void;
...
```
@param chart The chart to update.*/ updateChart(
      chart: SpreadsheetApp.EmbeddedChart,
    ): void;
  }
  interface Selection {
...
@return This builder, for chaining.*/ setLinkUrl(
      startOffset: Integer,
      endOffset: Integer,
      linkUrl: string,
...
@return This builder, for chaining.*/ setText(
      text: string,
    ): SpreadsheetApp.RichTextValueBuilder;
...
@return This builder, for chaining.*/ setTextStyle(
      startOffset: Integer,
      endOffset: Integer,
      textStyle: SpreadsheetApp.TextStyle,
    ): SpreadsheetApp.RichTextValueBuilder;
...
@return The link URL for this value, or `null` if there is no link or if multiple
    different links are in the given range.*/ getLinkUrl(
      startOffset: Integer,
      endOffset: Integer,
    ): string;
...
@param startOffset The start offset.
@param endOffset The end offset.
@return The text style of the given substring of this value.*/ getTextStyle(
      startOffset: Integer,
      endOffset: Integer,
    ): SpreadsheetApp.TextStyle;
  }
  interface RelativeDate {}
  interface _RelativeDate {
    ...
    /**Dates compared against the date before the current date.*/ YESTERDAY: RelativeDate;
  }
  interface RecalculationInterval {}
  interface _RecalculationInterval {
    ...
    /**Recalculate only when values are changed.*/ ON_CHANGE: RecalculationInterval;
  }
  interface RangeList {
...
@return This range list, for chaining.*/ clear(
      options: Object,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ insertCheckboxes(
      checkedValue: Object,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setBackground(
      color: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setBackgroundRGB(
      red: Integer,
      green: Integer,
      blue: Integer,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setBorder(
      top: boolean,
      left: boolean,
      bottom: boolean,
      right: boolean,
...
@return This range list, for chaining.*/ setFontColor(
      color: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFontFamily(
      fontFamily: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFontLine(
      fontLine: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFontSize(
      size: Integer,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFontStyle(
      fontStyle: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFontWeight(
      fontWeight: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setFormula(
      formula: string,
    ): SpreadsheetApp.RangeList;
    /**Updates the formula for each [`Range`](https://developers.google.com/apps-script/reference/spreadsheet/range.html) in the range list. The given formula must be in
R1C1 notation.
...
@return This range list, for chaining.*/ setFormulaR1C1(
      formula: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setHorizontalAlignment(
      alignment: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setNote(
      note: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setNumberFormat(
      numberFormat: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setShowHyperlink(
...
@param direction The desired text direction; if `null` the direction is inferred before
    setting.
@return This range list, for chaining.*/ setTextDirection(
...
@return This range list, for chaining.*/ setTextRotation(
      degrees: Integer,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setValue(
      value: Object,
    ): SpreadsheetApp.RangeList;
...
@param alignment The alignment, either `'top'`, `'middle'` or `'bottom'`; a
    `null` value resets the alignment.
@return This range list, for chaining.*/ setVerticalAlignment(
      alignment: string,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setVerticalText(
      isVertical: boolean,
    ): SpreadsheetApp.RangeList;
...
@return This range list, for chaining.*/ setWrap(
...
@return This range list, for chaining.*/ setWrapStrategy(
...
rangeList.uncheck();
```
@return This range list, for chaining.*/ uncheck(): SpreadsheetApp.RangeList;
  }
  interface Range {
    /**Sets the specified range as the [`active range`](https://developers.google.com/apps-script/reference/spreadsheet/selection.html#getActiveRange()), with the top
left cell in the range as the [`current cell`](https://developers.google.com/apps-script/reference/spreadsheet/selection.html#getCurrentCell()).
...
```
@param key The key for the new developer metadata.
@return This range, for chaining.*/ addDeveloperMetadata(
      key: string,
    ): SpreadsheetApp.Range;
...
@return The new banding.*/ applyColumnBanding(
...
@return The new banding.*/ applyRowBanding(
      bandingTheme: SpreadsheetApp.BandingTheme,
    ): SpreadsheetApp.Banding;
...
@param series The type of autoFill series that should be used to calculate new values. The
    effect of this series differs based on the type and amount of source data.*/ autoFill(
...
```
@param series The type of autoFill series that should be used to calculate new values. The
    effect of this series differs based on the type and amount of source data.*/ autoFillToNeighbor(
      series: SpreadsheetApp.AutoFillSeries,
    ): void;
...
```
@param options A JavaScript object that specifies advanced parameters, as listed below.
@return This range, for chaining.*/ clear(
      options: Object,
    ): SpreadsheetApp.Range;
...
@param rowEnd The end row of the target range.*/ copyFormatToRange(
      gridId: Integer,
      column: Integer,
      columnEnd: Integer,
      row: Integer,
...
```
@param destination A destination range to copy to; only the top-left cell position is relevant.*/ copyTo(
      destination: SpreadsheetApp.Range,
    ): void;
...
@param options A JavaScript object that specifies advanced parameters, as listed below.*/ copyTo(
      destination: SpreadsheetApp.Range,
      options: Object,
    ): void;
...
@param copyPasteType A type that specifies how the range contents are pasted to the
    destination.
@param transposed Whether the range should be pasted in its transposed orientation.*/ copyTo(
      destination: SpreadsheetApp.Range,
...
@param columnEnd The end column of the target range.
@param row The start row of the target range.
@param rowEnd The end row of the target range.*/ copyValuesToRange(
      gridId: Integer,
      column: Integer,
      columnEnd: Integer,
      row: Integer,
...
@return The newly created data source pivot table.*/ createDataSourcePivotTable(
...
```
@param dataSource The data source to create the pivot table from.
@return The newly created data source table.*/ createDataSourceTable(
      dataSource: SpreadsheetApp.DataSource,
...
@return The newly created [`PivotTable`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-table.html).*/ createPivotTable(
...
```
@param findText The text to search for.
@return The [`TextFinder`](https://developers.google.com/apps-script/reference/spreadsheet/text-finder.html) for the range*/ createTextFinder(
      findText: string,
    ): SpreadsheetApp.TextFinder;
...
```
@param shiftDimension The dimension along which to shift existing data.*/ deleteCells(
...
@return A range containing a single cell at the specified coordinates.*/ getCell(
      row: Integer,
      column: Integer,
    ): SpreadsheetApp.Range;
...
@return The data as a datatable.*/ getDataTable(
...
```
@param direction The direction in which to find the next data region edge cell.
@return The data region edge cell or the cell at the edge of the spreadsheet.*/ getNextDataCell(
      direction: SpreadsheetApp.Direction,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ insertCells(
      shiftDimension: SpreadsheetApp.Dimension,
    ): SpreadsheetApp.Range;
    /**Inserts checkboxes into each cell in the range, configured with `true` for checked and
`false` for unchecked. Sets the value of all cells in the range to `false`.
...
```
@param checkedValue The checked value for the checkbox data validation.
@return This range, for chaining.*/ insertCheckboxes(
      checkedValue: Object,
    ): SpreadsheetApp.Range;
    /**Inserts checkboxes into each cell in the range, configured with custom values for the checked
and unchecked states. Sets the value of each cell in the range to the custom unchecked value.
...
@return This range, for chaining.*/ offset(
      rowOffset: Integer,
...
@return The resulting range after removing duplicates. The size of the range is reduced by a
    row for every row removed.*/ removeDuplicates(
      columnsToCompare: Integer[],
    ): SpreadsheetApp.Range;
...
@param color A color code in CSS notation (such as `'#ffffff'` or `'white'`); a
    `null` value resets the color.
@return This range, for chaining.*/ setBackground(
      color: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setBackgroundObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setBackgroundObjects(
      color: SpreadsheetApp.Color[][],
    ): SpreadsheetApp.Range;
...
@param green The green value in RGB notation.
@param blue The blue value in RGB notation.
@return This range, for chaining.*/ setBackgroundRGB(
      red: Integer,
      green: Integer,
      blue: Integer,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setBackgrounds(
      color: string[][],
    ): SpreadsheetApp.Range;
...
@param vertical `true` for internal vertical borders, `false` for none, `null` for no change.
@param horizontal `true` for internal horizontal borders, `false` for none, `null` for no change.
@return This range, for chaining.*/ setBorder(
      top: boolean,
      left: boolean,
      bottom: boolean,
      right: boolean,
...
@return This range, for chaining.*/ setDataValidation(
...
@return This range, for chaining.*/ setDataValidations(
...
@param color The font color in CSS notation (such as `'#ffffff'` or `'white'`); a
    `null` value resets the color.
@return This range, for chaining.*/ setFontColor(
      color: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontColorObjects(
...
@param colors A two-dimensional array of colors in CSS notation (such as `'#ffffff'` or
    `'white'`); `null` values reset the color.
@return This range, for chaining.*/ setFontColors(
      colors: Object[][],
    ): SpreadsheetApp.Range;
...
@param fontFamilies A two-dimensional array of font families; `null` values reset the
    font family.
@return This range, for chaining.*/ setFontFamilies(
      fontFamilies: Object[][],
    ): SpreadsheetApp.Range;
...
```
@param fontFamily The font family to set; a `null` value resets the font family.
@return This range, for chaining.*/ setFontFamily(
      fontFamily: string,
    ): SpreadsheetApp.Range;
...
@param fontLine The font line style, either `'underline'`, `'line-through'`, or
    `'none'`; a `null` value resets the font line style.
@return This range, for chaining.*/ setFontLine(
      fontLine: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontLines(
      fontLines: Object[][],
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontSize(
      size: Integer,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontSizes(
      sizes: Object[][],
    ): SpreadsheetApp.Range;
...
@param fontStyle The font style, either `'italic'` or `'normal'`; a `null`
    value resets the font style.
@return This range, for chaining.*/ setFontStyle(
      fontStyle: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontStyles(
      fontStyles: Object[][],
    ): SpreadsheetApp.Range;
...
@param fontWeight The font weight, either `'bold'` or `'normal'`; a `null`
    value resets the font weight.
@return This range, for chaining.*/ setFontWeight(
      fontWeight: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFontWeights(
      fontWeights: Object[][],
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFormula(
      formula: string,
    ): SpreadsheetApp.Range;
...
```
@param formula A string formula.
@return This range, for chaining.*/ setFormulaR1C1(
      formula: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setFormulas(
      formulas: string[][],
    ): SpreadsheetApp.Range;
    /**Sets a rectangular grid of formulas (must match dimensions of this range). The given formulas
...
@return This range, for chaining.*/ setFormulasR1C1(
      formulas: string[][],
    ): SpreadsheetApp.Range;
...
@param alignment The alignment, either `'left'`, `'center'` or `'normal'`; a
    `null` value resets the alignment.
@return This range, for chaining.*/ setHorizontalAlignment(
      alignment: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setHorizontalAlignments(
      alignments: Object[][],
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setNotes(
      notes: Object[][],
    ): SpreadsheetApp.Range;
...
```
@param numberFormat A number format string.
@return This range, for chaining.*/ setNumberFormat(
      numberFormat: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setNumberFormats(
...
@return This range, for chaining.*/ setRichTextValue(
...
@return This range, for chaining.*/ setRichTextValues(
...
```
@param showHyperlink Whether or not to show the hyperlink.
@return This range, for chaining.*/ setShowHyperlink(
      showHyperlink: boolean,
    ): SpreadsheetApp.Range;
...
@param direction The desired text direction; if `null` the direction is inferred before
    setting.
@return This range, for chaining.*/ setTextDirection(
      direction: SpreadsheetApp.TextDirection,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setTextDirections(
...
@param degrees The desired angle between the standard orientation and the desired orientation.
    For left to right text, positive angles are in the counterclockwise direction.
@return This range, for chaining.*/ setTextRotation(
      degrees: Integer,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setTextRotations(
...
@return This range, for chaining.*/ setTextStyle(
...
@return This range, for chaining.*/ setTextStyles(
...
```
@param value The value for the range.
@return This range, for chaining.*/ setValue(
      value: Object,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setValues(
      values: Object[][],
    ): SpreadsheetApp.Range;
...
@param alignment The alignment, either `'top'`, `'middle'` or `'bottom'`; a
    `null` value resets the alignment.
@return This range, for chaining.*/ setVerticalAlignment(
      alignment: string,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setVerticalAlignments(
      alignments: Object[][],
    ): SpreadsheetApp.Range;
...
```
@param isVertical Whether or not to stack the text.
@return This range, for chaining.*/ setVerticalText(
      isVertical: boolean,
    ): SpreadsheetApp.Range;
...
```
@param isWrapEnabled Whether to wrap text or not.
@return This range, for chaining.*/ setWrap(
      isWrapEnabled: boolean,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setWrapStrategies(
...
```
@param strategy The desired wrapping strategy.
@return This range, for chaining.*/ setWrapStrategy(
      strategy: SpreadsheetApp.WrapStrategy,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ setWraps(
...
@return This range, for chaining.*/ shiftColumnGroupDepth(
      delta: Integer,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ shiftRowGroupDepth(
      delta: Integer,
    ): SpreadsheetApp.Range;
...
@return This range, for chaining.*/ sort(
      sortSpecObj: Object,
    ): SpreadsheetApp.Range;
...
// 3 |three            |three            |three            |
```
@param delimiter The preset delimiter to split on.*/ splitTextToColumns(
...
// 3 |three            |three            |three            |
```
@param delimiter The custom delimiter to split on.*/ splitTextToColumns(
      delimiter: string,
    ): void;
...
@return The borders for the enclosed cells.*/ getBorders(): SpreadsheetApp.Borders[][];
  }
  interface ProtectionType {}
  interface _ProtectionType {
    /**Protection for a range.*/ RANGE: ProtectionType;
    /**Protection for a sheet.*/ SHEET: ProtectionType;
  }
...
```
@param emailAddress The email address of the user to add.
@return The object representing the protection settings, for chaining.*/ addEditor(
      emailAddress: string,
    ): SpreadsheetApp.Protection;
    /**Adds the given user to the list of editors for the protected sheet or range. This method does
not automatically give the user permission to edit the spreadsheet itself; to do that in
...
```
@param emailAddresses An array of email addresses of the users to add.
@return The object representing the protection settings, for chaining.*/ addEditors(
      emailAddresses: string[],
    ): SpreadsheetApp.Protection;
...
@return The object representing the protection settings, for chaining.*/ addTargetAudience(
      audienceId: string,
    ): SpreadsheetApp.Protection;
...
```
@param emailAddress The email address of the user to remove.
@return The object representing the protection settings, for chaining.*/ removeEditor(
      emailAddress: string,
    ): SpreadsheetApp.Protection;
    /**Removes the given user from the list of editors for the protected sheet or range. Note that if
the user is a member of a Google Group that has edit permission, or if all users in the domain
...
@return the object representing the protection settings, for chaining*/ removeEditors(
      emailAddresses: string[],
    ): SpreadsheetApp.Protection;
...
@return The object representing the protection settings, for chaining.*/ removeTargetAudience(
      audienceId: string,
    ): SpreadsheetApp.Protection;
...
@return The object representing the protection settings, for chaining.*/ setDescription(
      description: string,
    ): SpreadsheetApp.Protection;
...
@return the object representing the protection settings, for chaining*/ setDomainEdit(
      editable: boolean,
    ): SpreadsheetApp.Protection;
...
@return The object representing the protection settings, for chaining.*/ setNamedRange(
...
@return The object representing the protection settings, for chaining.*/ setRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.Protection;
    /**Associates the protected range with an existing named range. If the named range covers a
different area from the current protected range, this method moves the protection to cover the
...
@return the object representing the protection settings, for chaining*/ setRangeName(
      rangeName: string,
    ): SpreadsheetApp.Protection;
...
@return the object representing the protection settings, for chaining*/ setUnprotectedRanges(
...
```
@return The object representing the protection settings, for chaining.*/ setWarningOnly(
      warningOnly: boolean,
    ): SpreadsheetApp.Protection;
  }
  interface PivotValueDisplayType {}
  interface _PivotValueDisplayType {
    ...
    /**Displays pivot values as a percent of the total for that row.*/ PERCENT_OF_ROW_TOTAL: PivotValueDisplayType;
  }
...
@return the pivot value for chaining*/ setDisplayName(
      name: string,
...
@param summarizeFunction The function to use to summarize data in this value's source data
    column.
@return the pivot value for chaining*/ summarizeBy(
      summarizeFunction: SpreadsheetApp.PivotTableSummarizeFunction,
    ): SpreadsheetApp.PivotValue;
  }
  interface PivotTableSummarizeFunction {}
  interface _PivotTableSummarizeFunction {
    ...
    /**The [VARP](https://support.google.com/docs/answer/3094113) function*/ VARP: PivotTableSummarizeFunction;
  }
...
@return the newly created [`PivotValue`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-value.html)*/ addCalculatedPivotValue(
      name: string,
      formula: string,
    ): SpreadsheetApp.PivotValue;
...
@return the newly created [`PivotGroup`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-group.html)*/ addColumnGroup(
...
@return the newly created [`PivotFilter`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-filter.html)*/ addFilter(
      sourceDataColumn: Integer,
      filterCriteria: SpreadsheetApp.FilterCriteria,
...
@param sourceDataColumn The number of the column this group summarizes. This index represents
    the absolute number of the column in the spreadsheet; `1` representing column "A,"
    `2` representing column B, etc.
@return the newly created [`PivotValue`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-value.html)*/ addPivotValue(
      sourceDataColumn: Integer,
      summarizeFunction: SpreadsheetApp.PivotTableSummarizeFunction,
    ): SpreadsheetApp.PivotValue;
...
@param sourceDataColumn The number of the column this group summarizes. This index represents
    the absolute number of the column in the spreadsheet; `1` representing column "A,"
    `2` representing column B, etc.
@return the newly created [`PivotGroup`](https://developers.google.com/apps-script/reference/spreadsheet/pivot-group.html)*/ addRowGroup(
      sourceDataColumn: Integer,
    ): SpreadsheetApp.PivotGroup;
...
@return the pivot table for chaining*/ setValuesDisplayOrientation(
      dimension: SpreadsheetApp.Dimension,
    ): SpreadsheetApp.PivotTable;
  }
...
@return The pivot group limit, for chaining.*/ setCountLimit(
      countLimit: Integer,
...
@return the pivot group for chaining.*/ addManualGroupingRule(
      groupName: string,
      groupMembers: Object[],
    ): SpreadsheetApp.PivotGroup;
...
@return the pivot group for chaining.*/ moveToIndex(
      index: Integer,
    ): SpreadsheetApp.PivotGroup;
...
@return the pivot group for chaining.*/ removeManualGroupingRule(
      groupName: string,
    ): SpreadsheetApp.PivotGroup;
...
@return The pivot group for chaining.*/ setGroupLimit(
      countLimit: Integer,
    ): SpreadsheetApp.PivotGroup;
...
@param maxValue The maximum value for items to be placed into buckets. Values greater than this
    are combined into a single bucket.
@return the pivot group for chaining.*/ setHistogramGroupingRule(
      minValue: Integer,
      maxValue: Integer,
...
@return the pivot group for chaining.*/ showTotals(
      showTotals: boolean,
    ): SpreadsheetApp.PivotGroup;
...
@return the pivot group for chaining.*/ sortBy(
...
@return the pivot filter for chaining*/ setFilterCriteria(
      filterCriteria: SpreadsheetApp.FilterCriteria,
    ): SpreadsheetApp.PivotFilter;
  }
...
```
@deprecated
@param user The email address of the user to remove.*/ removeUser(
      user: string,
    ): void;
...
@param protection `true` to enable sheet protection, `false` to disable sheet
    protection.*/ setProtected(protection: boolean): void;
  }
...
@return This image, for chaining.*/ assignScript(
      functionName: string,
    ): SpreadsheetApp.OverGridImage;
...
@return This image, for chaining.*/ replace(
      blob: BlobSource,
    ): SpreadsheetApp.OverGridImage;
...
@return the range whose name was set by the call*/ setName(
      name: string,
...
@return the named range for which the spreadsheet range was set*/ setRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.NamedRange;
  }
  interface LookerDataSourceSpecBuilder {
...
@return The builder, for chaining.*/ removeParameter(
      parameterName: string,
    ): SpreadsheetApp.LookerDataSourceSpecBuilder;
...
@return This builder, for chaining.*/ setExploreName(
      exploreName: string,
    ): SpreadsheetApp.LookerDataSourceSpecBuilder;
...
@return The builder, for chaining.*/ setInstanceUrl(
      instanceUrl: string,
    ): SpreadsheetApp.LookerDataSourceSpecBuilder;
...
@return The builder, for chaining.*/ setModelName(
      modelName: string,
    ): SpreadsheetApp.LookerDataSourceSpecBuilder;
...
@return The builder, for chaining.*/ setParameterFromCell(
      parameterName: string,
      sourceCell: string,
    ): SpreadsheetApp.LookerDataSourceSpecBuilder;
  }
...
@return The data source type.*/ getType(): SpreadsheetApp.DataSourceType;
  ...
  interface _InterpolationType {
    ...
    /**Use the number as a percentile interpolation point for a gradient condition.*/ PERCENTILE: InterpolationType;
  }
  interface GroupControlTogglePosition {}
  interface _GroupControlTogglePosition {
    /**The position where the control toggle is after the group (at higher indices).*/ AFTER: GroupControlTogglePosition;
    /**The position where the control toggle is before the group (at lower indices).*/ BEFORE: GroupControlTogglePosition;
  }
  interface Group {
...
set.
@return the minimum value if specified or an empty string*/ getMinValue(): string;
  }
  interface FrequencyType {}
  interface _FrequencyType {
    ...
    /**Refresh weekly, on given days of the week.*/ WEEKLY: FrequencyType;
  }
...
@return This builder, for chaining.*/ setHiddenValues(
      values: string[],
...
@return This builder, for chaining.*/ setVisibleBackgroundColor(
...
@param visibleForegroundColor The foreground color to set. The color must be an RGB-style
    color. This method doesn't support theme colors.
@return This builder, for chaining.*/ setVisibleForegroundColor(
...
@return This builder, for chaining.*/ setVisibleValues(
      values: string[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateAfter(
      date: Date,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateBefore(
      date: Date,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateEqualTo(
      date: Date,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateEqualToAny(
      dates: Date[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateNotEqualTo(
      date: Date,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenDateNotEqualToAny(
      dates: Date[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenFormulaSatisfied(
      formula: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberEqualTo(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberEqualToAny(
      numbers: number[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberGreaterThan(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberGreaterThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberLessThan(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberLessThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberNotBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberNotEqualTo(
      number: number,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenNumberNotEqualToAny(
      numbers: number[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextContains(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextDoesNotContain(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextEndsWith(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextEqualTo(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextEqualToAny(
      texts: string[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextNotEqualTo(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextNotEqualToAny(
      texts: string[],
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ whenTextStartsWith(
      text: string,
    ): SpreadsheetApp.FilterCriteriaBuilder;
...
@return This builder, for chaining.*/ withCriteria(
...
@return The filter criteria.*/ getColumnFilterCriteria(
      columnPosition: Integer,
...
```
@param columnPosition The 1-indexed position of the column. For example, column B's index is 2.
@return The filter, for chaining.*/ removeColumnFilterCriteria(
      columnPosition: Integer,
...
@return The filter, for chaining.*/ setColumnFilterCriteria(
      columnPosition: Integer,
      filterCriteria: SpreadsheetApp.FilterCriteria,
    ): SpreadsheetApp.Filter;
...
@return The filter, for chaining.*/ sort(
      columnPosition: Integer,
      ascending: boolean,
    ): SpreadsheetApp.Filter;
...
@param columnPosition The 1-indexed position of the column. For example, column B's index is 2.
@return The sort specification.*/ getColumnSortSpec(
      columnPosition: Integer,
...
@return This builder, useful for chaining.*/ enablePaging(
...
@param rtlEnabled `true` if right-to-left support should be enabled, `false`
    otherwise.
@return This builder, useful for chaining.*/ enableRtlTable(
      rtlEnabled: boolean,
    ): SpreadsheetApp.EmbeddedTableChartBuilder;
...
@return This builder, useful for chaining.*/ enableSorting(
...
@return this builder, for chaining*/ removeRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.EmbeddedChartBuilder;
...
@return this builder, for chaining*/ setChartType(
...
@return This builder, useful for chaining.*/ setFirstRowNumber(
      number: Integer,
    ): SpreadsheetApp.EmbeddedTableChartBuilder;
...
@return this builder, for chaining*/ setHiddenDimensionStrategy(
...
@return This builder, useful for chaining.*/ setInitialSortingAscending(
      column: Integer,
    ): SpreadsheetApp.EmbeddedTableChartBuilder;
    /**Sets the index of the column according to which the table should be initially sorted
(descending).
...
```
@param column The number of the column according to which the table should be initially sorted.
@return This builder, useful for chaining.*/ setInitialSortingDescending(
      column: Integer,
    ): SpreadsheetApp.EmbeddedTableChartBuilder;
...
@return this builder, for chaining*/ setMergeStrategy(
...
@param headers The number of rows or columns to treat as headers. Negative values cause headers
    to be auto-detected.
@return this builder, for chaining*/ setNumHeaders(
      headers: Integer,
    ): SpreadsheetApp.EmbeddedChartBuilder;
...
@return This builder, for chaining.*/ setOption(
      option: string,
      value: Object,
    ): SpreadsheetApp.EmbeddedChartBuilder;
...
@return this builder, for chaining*/ setPosition(
      anchorRowPos: Integer,
      anchorColPos: Integer,
      offsetX: Integer,
      offsetY: Integer,
...
@param transpose If `true`, the rows and columns used to construct the chart are
    transposed.
@return this builder, for chaining*/ setTransposeRowsAndColumns(
      transpose: boolean,
    ): SpreadsheetApp.EmbeddedChartBuilder;
...
@param showRowNumber `true` if the first column of the table should show the row number,
    `false` otherwise.
@return This builder, useful for chaining.*/ showRowNumberColumn(
...
@return This builder, useful for chaining.*/ useAlternatingRowStyle(
      alternate: boolean,
    ): SpreadsheetApp.EmbeddedTableChartBuilder;
  }
...
@return This builder, useful for chaining.*/ setBackgroundColor(
      cssValue: string,
...
@return This builder, useful for chaining.*/ setColors(
      cssValues: string[],
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
    /**Sets the strategy to use for hidden rows and columns. Defaults to [`IGNORE_ROWS`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/chart-hidden-dimension-strategy.html).
...
@return This builder, useful for chaining.*/ setLegendPosition(
...
@return This builder, useful for chaining.*/ setLegendTextStyle(
...
@return This builder, useful for chaining.*/ setPointStyle(
...
@return This builder, useful for chaining.*/ setTitle(
      chartTitle: string,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
@return This builder, useful for chaining.*/ setTitleTextStyle(
      textStyle: Charts.TextStyle,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
    /**Sets whether the chart's rows and columns are transposed. If set to `true`, the rows and
columns are switched. Defaults to `false`.
...
@return This builder, useful for chaining.*/ setXAxisRange(
      start: number,
      end: number,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
@return This builder, useful for chaining.*/ setXAxisTextStyle(
      textStyle: Charts.TextStyle,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
@return This builder, useful for chaining.*/ setXAxisTitle(
      title: string,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
```
@param textStyle The text style to use for the horizontal axis title. You can create a [`TextStyleBuilder`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/text-style-builder.html) object by calling [`Charts.newTextStyle()`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/charts.html#newTextStyle()).
@return This builder, useful for chaining.*/ setXAxisTitleTextStyle(
      textStyle: Charts.TextStyle,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
@return This builder, useful for chaining.*/ setYAxisRange(
      start: number,
      end: number,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
```
@param textStyle The text style to use for the horizontal axis title. You can create a [`TextStyleBuilder`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/text-style-builder.html) object by calling [`Charts.newTextStyle()`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/charts.html#newTextStyle()).
@return This builder, useful for chaining.*/ setYAxisTextStyle(
      textStyle: Charts.TextStyle,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
@return This builder, useful for chaining.*/ setYAxisTitle(
      title: string,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
...
```
@param textStyle The text style to use for the horizontal axis title. You can create a [`TextStyleBuilder`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/text-style-builder.html) object by calling [`Charts.newTextStyle()`](https://developers.google.com/apps-script/reference/spreadsheet/../charts/charts.html#newTextStyle()).
@return This builder, useful for chaining.*/ setYAxisTitleTextStyle(
      textStyle: Charts.TextStyle,
    ): SpreadsheetApp.EmbeddedScatterChartBuilder;
  }
...
@return This builder, useful for chaining.*/ setCurveStyle(
...
@return This builder, useful for chaining.*/ setRange(
      start: number,
      end: number,
    ): SpreadsheetApp.EmbeddedLineChartBuilder;
    /**Sets the title of the chart. The title is displayed centered above the chart.
...
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedLineChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedHistogramChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedComboChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedColumnChartBuilder;
  }
...
```
@return a builder for creating embedded charts*/ modify(): SpreadsheetApp.EmbeddedChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedBarChartBuilder;
  }
...
axis are the vertical axis for vertical charts (such as line, area, or column) and the
horizontal axis for horizontal charts (such as bar).
@return This builder, useful for chaining.*/ useLogScale(): SpreadsheetApp.EmbeddedAreaChartBuilder;
  }
  interface Drawing {
...
@return This drawing, for chaining.*/ setPosition(
      anchorRowPos: Integer,
      anchorColPos: Integer,
      offsetX: Integer,
      offsetY: Integer,
...
@param width The desired width in pixels.
@return This drawing, for chaining.*/ setWidth(
      width: Integer,
    ): SpreadsheetApp.Drawing;
    /**Sets the z-index of this drawing.
@param zIndex Z-Index of this drawing.
@return This drawing, for chaining.*/ setZIndex(
      zIndex: number,
    ): SpreadsheetApp.Drawing;
  }
  interface Direction {}
  interface _Direction {
    ...
    /**The direction of decreasing row indices.*/ UP: Direction;
  }
  interface Dimension {}
  interface _Dimension {
    /**The column (vertical) dimension.*/ COLUMNS: Dimension;
    /**The row (horizontal) dimension.*/ ROWS: Dimension;
  }
  interface DeveloperMetadataVisibility {}
  interface _DeveloperMetadataVisibility {
...
to store secrets. It can be exposed to users with view access to the document.*/ PROJECT: DeveloperMetadataVisibility;
  }
  interface DeveloperMetadataLocationType {}
  interface _DeveloperMetadataLocationType {
    ...
    /**The location type for developer metadata associated with the top-level spreadsheet.*/ SPREADSHEET: DeveloperMetadataLocationType;
  }
...
@return The [`Spreadsheet`](https://developers.google.com/apps-script/reference/spreadsheet/spreadsheet.html) location of this metadata, or `null` if the location
    type is not `DeveloperMetadataLocationType.SPREADSHEET`.*/ getSpreadsheet(): SpreadsheetApp.Spreadsheet;
  }
...
@return The developer metadata finder, for chaining.*/ withId(
      id: Integer,
...
@return The developer metadata finder, for chaining.*/ withKey(
      key: string,
    ): SpreadsheetApp.DeveloperMetadataFinder;
...
@return The developer metadata finder, for chaining.*/ withLocationType(
...
@return The developer metadata finder, for chaining.*/ withValue(
      value: string,
    ): SpreadsheetApp.DeveloperMetadataFinder;
...
@return The developer metadata finder, for chaining.*/ withVisibility(
      visibility: SpreadsheetApp.DeveloperMetadataVisibility,
    ): SpreadsheetApp.DeveloperMetadataFinder;
  }
...
@param column The range representing the column that is the new location for this developer
    metadata.
@return The developer metadata, for chaining.*/ moveToColumn(
      column: SpreadsheetApp.Range,
...
@return The developer metadata, for chaining.*/ moveToRow(
      row: SpreadsheetApp.Range,
    ): SpreadsheetApp.DeveloperMetadata;
...
@return The developer metadata, for chaining.*/ moveToSheet(
      sheet: SpreadsheetApp.Sheet,
    ): SpreadsheetApp.DeveloperMetadata;
...
@return The developer metadata, for chaining.*/ setKey(
      key: string,
    ): SpreadsheetApp.DeveloperMetadata;
...
@return The developer metadata, for chaining.*/ setValue(
      value: string,
    ): SpreadsheetApp.DeveloperMetadata;
...
@return The developer metadata, for chaining.*/ setVisibility(
      visibility: SpreadsheetApp.DeveloperMetadataVisibility,
    ): SpreadsheetApp.DeveloperMetadata;
  }
  interface DateTimeGroupingRuleType {}
  interface _DateTimeGroupingRuleType {
    ...
    /**Group date-time by year and quarter, for example `2008 Q4` .*/ YEAR_QUARTER: DateTimeGroupingRuleType;
  }
  interface DateTimeGroupingRule {
    /**Gets the type of the date-time grouping rule.
@return The rule type.*/ getRuleType(): SpreadsheetApp.DateTimeGroupingRuleType;
  }
  interface DataValidationCriteria {}
  interface _DataValidationCriteria {
    ...
    /**Requires that the input is equal to a value in the given range.*/ VALUE_IN_RANGE: DataValidationCriteria;
  }
...
@return this builder, for chaining*/ requireCheckbox(
      checkedValue: Object,
...
@return this builder, for chaining*/ requireDateAfter(
      date: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateBefore(
      date: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateBetween(
      start: Date,
      end: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateEqualTo(
      date: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateNotBetween(
      start: Date,
      end: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateOnOrAfter(
      date: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireDateOnOrBefore(
      date: Date,
    ): SpreadsheetApp.DataValidationBuilder;
...
```
@param formula A custom formula that evaluates to `true` if the input is valid.
@return this builder, for chaining*/ requireFormulaSatisfied(
      formula: string,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberEqualTo(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberGreaterThan(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberGreaterThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberLessThan(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberLessThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberNotBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireNumberNotEqualTo(
      number: number,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireTextContains(
      text: string,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireTextDoesNotContain(
      text: string,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireTextEqualTo(
      text: string,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return this builder, for chaining*/ requireValueInList(
      values: string[],
    ): SpreadsheetApp.DataValidationBuilder;
    /**Sets the data validation rule to require that the input is equal to one of the given values,
...
@return this builder, for chaining*/ requireValueInRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.DataValidationBuilder;
    /**Sets the data validation rule to require that the input is equal to a value in the given range,
with an option to hide the dropdown menu.
...
@param allowInvalidData `true` if the rule should allow input that fails data validation;
    `false` if not.
@return this builder, for chaining*/ setAllowInvalid(
...
@return this builder, for chaining*/ setHelpText(
      helpText: string,
    ): SpreadsheetApp.DataValidationBuilder;
...
@return the rule's help text, or `null` if no help text is set*/ getHelpText(): string;
  ...
  interface _DataSourceType {
    ...
    /**A Looker data source.*/ LOOKER: DataSourceType;
  }
...
@param filterCriteria The filter criteria to set.
@return The filter for chaining.*/ setFilterCriteria(
      filterCriteria: SpreadsheetApp.FilterCriteria,
...
@return The data source column.*/ getDataSourceColumn(): SpreadsheetApp.DataSourceColumn;
    /**Removes the column from the [`DataSourceTable`](https://developers.google.com/apps-script/reference/spreadsheet/data-source-table.html).*/ remove(): void;
  }
...
@return The data source table, for chaining.*/ addColumns(
      columnNames: string[],
    ): SpreadsheetApp.DataSourceTable;
...
@return The data source table, for chaining.*/ addFilter(
      columnName: string,
      filterCriteria: SpreadsheetApp.FilterCriteria,
    ): SpreadsheetApp.DataSourceTable;
...
@return The data source sheet, for chaining.*/ addSortSpec(
      columnName: string,
      ascending: boolean,
    ): SpreadsheetApp.DataSourceTable;
    /**Adds a sort spec on a column in the data source table.
...
@return The data source table, for chaining.*/ setRowLimit(
      rowLimit: Integer,
    ): SpreadsheetApp.DataSourceTable;
...
@param timeoutInSeconds The time to wait for data execution, in seconds. The maximum is 300
    seconds.
@return The data execution status.*/ waitForCompletion(
      timeoutInSeconds: Integer,
...
@param columnName The name of the column to apply this filter to.
@param filterCriteria The filter criteria to apply.
@return The data source sheet, for method chaining.*/ addFilter(
      columnName: string,
      filterCriteria: SpreadsheetApp.FilterCriteria,
    ): SpreadsheetApp.DataSourceSheet;
...
@return This data source sheet, for chaining.*/ autoResizeColumn(
      columnName: string,
    ): SpreadsheetApp.DataSourceSheet;
    /**Auto resizes the width of the specified columns.
@param columnNames The list of column names to update.
@return This data source sheet, for chaining.*/ autoResizeColumns(
      columnNames: string[],
    ): SpreadsheetApp.DataSourceSheet;
    /**Cancels the data refresh associated with this object if it's currently running.
...
@param columnName The column name.
@return The column's width, or `null` if the column uses the default width.*/ getColumnWidth(
      columnName: string,
    ): Integer;
    /**Gets the data source the object is linked to.
@return The data source.*/ getDataSource(): SpreadsheetApp.DataSource;
...
@return A one-dimensional array of values.*/ getSheetValues(
      columnName: string,
    ): Object[];
...
@return The data source sheet, for method chaining.*/ removeFilters(
      columnName: string,
    ): SpreadsheetApp.DataSourceSheet;
    /**Removes the sort spec on a column in the data source sheet.
@param columnName The name of the column.
@return The data source sheet, for chaining.*/ removeSortSpec(
      columnName: string,
    ): SpreadsheetApp.DataSourceSheet;
    /**Sets the width of the specified column.
@param columnName The column name.
@param width The new width for the column.
@return This data source sheet, for chaining.*/ setColumnWidth(
      columnName: string,
      width: Integer,
    ): SpreadsheetApp.DataSourceSheet;
...
@return This data source sheet, for chaining.*/ setColumnWidths(
      columnNames: string[],
      width: Integer,
    ): SpreadsheetApp.DataSourceSheet;
...
@param ascending If `true`, sort the column in ascending order; if `false`, sort
    the column in descending order.
@return The data source sheet, for chaining.*/ setSortSpec(
      columnName: string,
      ascending: boolean,
    ): SpreadsheetApp.DataSourceSheet;
    /**Sets the sort spec on a column in the data source sheet.
...
@return The data execution status.*/ waitForCompletion(
  ...
  interface DataSourceRefreshScope {}
  interface _DataSourceRefreshScope {
    /**The refresh applies to all data sources in the spreadsheet.*/ ALL_DATA_SOURCES: DataSourceRefreshScope;
    /**The data source refresh scope is unsupported.*/ DATA_SOURCE_REFRESH_SCOPE_UNSUPPORTED: DataSourceRefreshScope;
  }
...
spreadsheet.
@return The start hour.*/ getStartHour(): Integer;
  }
...
@return Whether this refresh schedule is enabled.*/ isEnabled(): boolean;
  }
...
@return The new pivot group.*/ addColumnGroup(
      columnName: string,
    ): SpreadsheetApp.PivotGroup;
...
@return The new filter.*/ addFilter(
      columnName: string,
      filterCriteria: SpreadsheetApp.FilterCriteria,
    ): SpreadsheetApp.PivotFilter;
...
@return The new pivot value.*/ addPivotValue(
      columnName: string,
    ): SpreadsheetApp.PivotValue;
...
@param columnName The data source column name the pivot group is based on.
@return The new pivot group.*/ addRowGroup(
      columnName: string,
    ): SpreadsheetApp.PivotGroup;
...
@return The data execution status.*/ waitForCompletion(
  ...
  interface DataSourceParameterType {}
  interface _DataSourceParameterType {
    /**The data source parameter is valued based on a cell.*/ CELL: DataSourceParameterType;
    /**A data source parameter type that is not supported in Apps Script.*/ DATA_SOURCE_PARAMETER_TYPE_UNSUPPORTED: DataSourceParameterType;
  }
...
@return The parameter type.*/ getType(): SpreadsheetApp.DataSourceParameterType;
  }
...
@return The data source formula, for chaining.*/ setFormula(
      formula: string,
...
@param formula The new formula.
@return The data source column, for chaining.*/ setFormula(
      formula: string,
...
@return The data source column, for chaining.*/ setName(
      name: string,
    ): SpreadsheetApp.DataSourceColumn;
  }
...
@return The newly created calculated column.*/ createCalculatedColumn(
      name: string,
      formula: string,
    ): SpreadsheetApp.DataSourceColumn;
...
@return The calculated column that matches the column name, or `null` if there is no such
    calculated column.*/ getCalculatedColumnByName(
      columnName: string,
    ): SpreadsheetApp.DataSourceColumn;
...
@return The data source.*/ updateSpec(
      spec: SpreadsheetApp.DataSourceSpec,
...
otherwise.
@return `True` if the data from execution is truncated, or `false` otherwise.*/ isTruncated(): boolean;
  }
  interface DataExecutionState {}
  interface _DataExecutionState {
    ...
    /**The data execution is completed and successful.*/ SUCCESS: DataExecutionState;
  }
  interface DataExecutionErrorCode {}
  interface _DataExecutionErrorCode {
...
For BigQuery, `ARRAY` or `STRUCT` type is not supported.*/ UNSUPPORTED_DATA_TYPE: DataExecutionErrorCode;
  }
  interface CopyPasteType {}
  interface _CopyPasteType {
    ...
    /**Paste the values ONLY without formats, formulas or merges.*/ PASTE_VALUES: CopyPasteType;
  }
...
@return the vertical offset in pixels for the upper left hand corner of the chart*/ getOffsetY(): Integer;
  }
...
@return the builder, for chaining*/ setBackground(
      color: string,
...
@return The builder, for chaining.*/ setBackgroundObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param color The desired color or `null` to clear.
@return the builder, for chaining*/ setFontColor(
      color: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
    /**Sets the font color for the conditional format rule's format. Passing in `null` removes
the font color format setting from the rule.
...
```
@param color The desired color object or `null` to clear.
@return The builder, for chaining.*/ setFontColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ setGradientMaxpoint(
      color: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
    /**Clears the conditional format rule's gradient maxpoint value, and instead uses the maximum
value in the rule's ranges. Also sets the gradient's maxpoint color to the input color.
...
@return The builder, for chaining.*/ setGradientMaxpointObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return The builder, for chaining.*/ setGradientMaxpointObjectWithValue(
      color: SpreadsheetApp.Color,
...
@param type The maxpoint interpolation type to set.
@param value The maxpoint value to set.
@return the builder, for chaining*/ setGradientMaxpointWithValue(
      color: string,
      type: SpreadsheetApp.InterpolationType,
      value: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return The builder, for chaining.*/ setGradientMidpointObjectWithValue(
      color: SpreadsheetApp.Color,
      type: SpreadsheetApp.InterpolationType,
      value: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@param type The midpoint interpolation type to set or `null` to clear.
@param value The midpoint value to set.
@return the builder, for chaining*/ setGradientMidpointWithValue(
      color: string,
      type: SpreadsheetApp.InterpolationType,
      value: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ setGradientMinpoint(
      color: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
    /**Clears the conditional format rule's gradient minpoint value, and instead uses the minimum
value in the rule's ranges. Also sets the gradient's minpoint color to the input color.
...
@return The builder, for chaining.*/ setGradientMinpointObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return The builder, for chaining.*/ setGradientMinpointObjectWithValue(
      color: SpreadsheetApp.Color,
      type: SpreadsheetApp.InterpolationType,
      value: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@param type The minpoint interpolation type to set.
@param value The minpoint value to set.
@return the builder, for chaining*/ setGradientMinpointWithValue(
      color: string,
      type: SpreadsheetApp.InterpolationType,
      value: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ setRanges(
      ranges: SpreadsheetApp.Range[],
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ whenDateAfter(
      date: Date,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param date The earliest unacceptable date.
@return the builder, for chaining*/ whenDateBefore(
      date: Date,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param date The sole acceptable date.
@return the builder, for chaining*/ whenDateEqualTo(
      date: Date,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param formula A custom formula that evaluates to `true` if the input is valid.
@return the builder, for chaining*/ whenFormulaSatisfied(
      formula: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@param start The lowest acceptable value.
@param end The highest acceptable value.
@return the builder, for chaining*/ whenNumberBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The sole acceptable value.
@return the builder, for chaining*/ whenNumberEqualTo(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The highest unacceptable value.
@return the builder, for chaining*/ whenNumberGreaterThan(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The lowest acceptable value.
@return the builder, for chaining*/ whenNumberGreaterThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The lowest unacceptable value.
@return the builder, for chaining*/ whenNumberLessThan(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The highest acceptable value.
@return the builder, for chaining*/ whenNumberLessThanOrEqualTo(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@param start The lowest unacceptable value.
@param end The highest unacceptable value.
@return the builder, for chaining*/ whenNumberNotBetween(
      start: number,
      end: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param number The sole unacceptable value.
@return the builder, for chaining*/ whenNumberNotEqualTo(
      number: number,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param text The value that the input must contain.
@return the builder, for chaining*/ whenTextContains(
      text: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param text The value that the input must not contain.
@return the builder, for chaining*/ whenTextDoesNotContain(
      text: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ whenTextEndsWith(
      text: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
```
@param text The sole acceptable value.
@return the builder, for chaining*/ whenTextEqualTo(
      text: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ whenTextStartsWith(
      text: string,
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
...
@return the builder, for chaining*/ withCriteria(
      criteria: SpreadsheetApp.BooleanCriteria,
      args: Object[],
    ): SpreadsheetApp.ConditionalFormatRuleBuilder;
  }
...
@return This builder, for chaining.*/ setRgbColor(
      cssString: string,
    ): SpreadsheetApp.ColorBuilder;
    /**Sets as theme color.
@param themeColorType The theme color type.
@return This builder, for chaining.*/ setThemeColor(
      themeColorType: SpreadsheetApp.ThemeColorType,
    ): SpreadsheetApp.ColorBuilder;
  }
  interface Color {
...
@param url The URL for the image.
@return This builder, for chaining.*/ setSourceUrl(
      url: string,
    ): SpreadsheetApp.CellImageBuilder;
...
@return A builder that creates an image value type based on the given image properties.*/ toBuilder(): SpreadsheetApp.CellImageBuilder;
  }
  interface CellImage {
    /**A field set to `ValueType.IMAGE`, representing the image value type.*/ valueType: SpreadsheetApp._ValueType;
    /**Returns the alt text description for this image.
...
@return The top border.*/ getTop(): SpreadsheetApp.Border;
  }
  interface BorderStyle {}
  interface _BorderStyle {
    ...
    /**Thick solid line borders.*/ SOLID_THICK: BorderStyle;
  }
  interface Border {
...
@return The border color.*/ getColor(): SpreadsheetApp.Color;
  }
  interface BooleanCriteria {}
  interface _BooleanCriteria {
    ...
    /**The criteria is met when the input begins with the given value.*/ TEXT_STARTS_WITH: BooleanCriteria;
  }
...
@return whether or not the boolean condition underlines the text, or `null` if
    underlining is unaffected*/ getUnderline(): boolean;
  }
...
@return This builder, for chaining.*/ setDatasetId(
      datasetId: string,
    ): SpreadsheetApp.BigQueryDataSourceSpecBuilder;
    /**Adds a parameter, or if the parameter with the name exists, updates its source cell for data
source spec builders of type [`DataSourceType.BIGQUERY`](https://developers.google.com/apps-script/reference/spreadsheet/data-source-type.html#BIGQUERY).
...
@return The data source type.*/ getType(): SpreadsheetApp.DataSourceType;
  ...
  interface BandingTheme {}
  interface _BandingTheme {
...
@return This banding, for chaining.*/ setFirstColumnColor(
      color: string,
    ): SpreadsheetApp.Banding;
...
@param color The new first alternating column color in the banding; setting to `null`
    clears the color.
@return This banding, for chaining.*/ setFirstColumnColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the first row color that is alternating.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setFirstRowColor(
      color: string,
    ): SpreadsheetApp.Banding;
...
@param color The new first alternating color in the banding; setting to `null` clears the
    color.
@return This banding, for chaining.*/ setFirstRowColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the last column.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setFooterColumnColor(
      color: string,
    ): SpreadsheetApp.Banding;
...
@param color The new color of the last column in the banding; setting to `null` clears
    the color.
@return This banding, for chaining.*/ setFooterColumnColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the last row.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setFooterRowColor(
      color: string,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the footer row in the banding.
@param color The new footer row color; setting to `null` clears the color.
@return This banding, for chaining.*/ setFooterRowColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the header column.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setHeaderColumnColor(
      color: string,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the header column.
@param color The new header column color; setting to `null` clears the color.
@return This banding, for chaining.*/ setHeaderColumnColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the header row.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setHeaderRowColor(
      color: string,
    ): SpreadsheetApp.Banding;
    /**Sets the color of the header row.
@param color The new header row color; setting to `null` clears the color.
@return This banding, for chaining.*/ setHeaderRowColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the range for this banding.
@param range The new range for this banding.
@return This banding, for chaining.*/ setRange(
      range: SpreadsheetApp.Range,
    ): SpreadsheetApp.Banding;
    /**Sets the second column color that is alternating.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setSecondColumnColor(
      color: string,
    ): SpreadsheetApp.Banding;
...
@param color The new second alternating column color in the banding; setting to `null`
    clears the color.
@return This banding, for chaining.*/ setSecondColumnColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
    /**Sets the second row color that is alternating.
@param color The color code in CSS notation (such as `'#ffffff'` or `'white'`), or
    `null` to clear the color.
@return This banding, for chaining.*/ setSecondRowColor(
      color: string,
    ): SpreadsheetApp.Banding;
...
@param color The new second alternating color in the banding; setting to `null` clears
    the color.
@return This banding, for chaining.*/ setSecondRowColorObject(
      color: SpreadsheetApp.Color,
    ): SpreadsheetApp.Banding;
  }
  interface AutoFillSeries {}
  interface _AutoFillSeries {
...
filled with increments of the existing values.*/ DEFAULT_SERIES: AutoFillSeries;
  }
}
