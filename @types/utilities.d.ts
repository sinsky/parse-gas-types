interface Utilities {
  Charset: Utilities._Charset;
  DigestAlgorithm: _DigestAlgorithm;
  MacAlgorithm: Utilities._MacAlgorithm;
  RsaAlgorithm: Utilities._RsaAlgorithm;
...
@return The raw data represented by the base-64 encoded argument as a byte array.*/ base64Decode(
    encoded: string,
  ): Byte[];
...
@return The raw data represented by the base-64 web-safe encoded argument as a byte array.*/ base64DecodeWebSafe(
    encoded: string,
  ): Byte[];
...
@return The base-64 encoded representation of the passed in data.*/ base64Encode(
    data: Byte[],
  ): string;
...
@return The base-64 encoded representation of the input string.*/ base64Encode(
    data: string,
  ): string;
...
@return The base-64 encoded representation of the input string with the given `Charset`.*/ base64Encode(
    data: string,
    charset: Utilities.Charset,
  ): string;
...
@return The base-64 web-safe encoded representation of the passed in data.*/ base64EncodeWebSafe(
    data: Byte[],
  ): string;
...
```
@param data The string to encode.
@return The base-64 web-safe encoded representation of the input string.*/ base64EncodeWebSafe(
    data: string,
  ): string;
...
@param data The string of data to encode.
@param charset A `Charset` specifying the charset of the input.
@return The base-64 web-safe encoded representation of the input string with the given `Charset`.*/ base64EncodeWebSafe(
    data: string,
    charset: Utilities.Charset,
  ): string;
...
@return A byte[] representing the output digest.*/ computeDigest(
...
@return A byte[] representing the output signature.*/ computeHmacSha256Signature(
    value: Byte[],
    key: Byte[],
  ): Byte[];
  /**Signs the provided value using HMAC-SHA256 with the given key.
...
@param value The input value to generate a hash for.
@param key A key to use to generate the hash with.
@return A byte[] representing the output signature.*/ computeHmacSignature(
...
@return A byte[] representing the output signature.*/ computeRsaSha1Signature(
    value: string,
    key: string,
  ): Byte[];
...
@param value The input value to generate a hash for.
@param key A PEM formatted key to use to generate the signature.
@return A byte[] representing the output signature.*/ computeRsaSha256Signature(
    value: string,
    key: string,
  ): Byte[];
  /**Signs the provided value using RSA-SHA256 with the given key.
...
@param value The input value to generate a hash for.
@param key A PEM formatted key to use to generate the signature.
@return A byte[] representing the output signature.*/ computeRsaSignature(
...
@return The input date as a formatted string.*/ formatDate(
    date: Date,
    timeZone: string,
    format: string,
  ): string;
...
@return The formatted string.*/ formatString(
    template: string,
    ...args: Object[]
  ): string;
...
@return A new [`Blob`](https://developers.google.com/apps-script/reference/utilities/../base/blob.html) containing the compressed data.*/ gzip(
    blob: BlobSource,
  ): Blob;
...
@return A JavaScript object representation of the input.*/ jsonParse(
    jsonString: string,
  ): Object;
...
@return a JSON serialized JavaScript object*/ jsonStringify(
    obj: Object,
  ): string;
...
@return The newly created Blob.*/ newBlob(
    data: Byte[],
    contentType: string,
  ): Blob;
...
@param csv A string containing a single or multiline data in comma-separated value (CSV)
    format.
@return A two-dimensional array containing the values in the CSV string.*/ parseCsv(
    csv: string,
  ): string[][];
...
@return The input string as a date.*/ parseDate(
    date: string,
    timeZone: string,
    format: string,
  ): Date;
...
```
@param milliseconds The number of milliseconds to sleep.*/ sleep(
...
@return A [`Blob`](https://developers.google.com/apps-script/reference/utilities/../base/blob.html) representing the decompressed data.*/ ungzip(
    blob: BlobSource,
  ): Blob;
...
@return A new blob containing the inputs as an archive.*/ zip(
    blobs: BlobSource[],
  ): Blob;
...
module Utilities {
  ...
  interface _RsaAlgorithm {
    RSA_SHA_1: RsaAlgorithm;
    RSA_SHA_256: RsaAlgorithm;
  }
  interface MacAlgorithm {}
  interface _MacAlgorithm {
    HMAC_MD5: MacAlgorithm;
    HMAC_SHA_1: MacAlgorithm;
    HMAC_SHA_256: MacAlgorithm;
    HMAC_SHA_384: MacAlgorithm;
    HMAC_SHA_512: MacAlgorithm;
  }
  interface Charset {}
  interface _Charset {
    US_ASCII: Charset;
